...
public class CellGridBinaryCacheObject extends AbstractCacheObject implements ICellGridCacheObject {
  ...
  public CellGridBinaryCacheObject(
      String cacheIdentifier, File cacheLocation, InputStream inputStream) {
  ...
  public void initializeObjectFromCache(CellGrid object) throws CacheException {
    try {
      ...
      CellGridReadWriter.read(object)
          .fromBinary(new DataInputStream(new FastBufferedInputStream(inputStream)));
    } catch (Exception e) {
