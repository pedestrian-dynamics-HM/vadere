...
public class ScenarioChecker {
  ...
  public PriorityQueue<ScenarioCheckerMessage> checkObstacleArea() {
    return runCheck(new ObstacleAreaCheck());
  }

  public PriorityQueue<ScenarioCheckerMessage> checkTargetNoAbsorber() {
    return runCheck(new ExistingAbsorberCheck());
  }

  public PriorityQueue<ScenarioCheckerMessage> checkTargetAbsorberNotLast() {
    return runCheck(new LastIsAbsorberCheck());
  }
