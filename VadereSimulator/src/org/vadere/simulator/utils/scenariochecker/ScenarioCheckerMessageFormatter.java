...
public interface ScenarioCheckerMessageFormatter {
  ...
  /**
   * Return a String representation of the given Messages in the order of the given PriorityQueue
   * Errors -> Warnings
   *
  ...
  /**
   * Return a String representation of the given Messages in the order of the given PriorityQueue.
   * Only return messages matching any of the Types given by typeFilter
   *
   * @param msg List of Messages
   * @param typeFilter only include messages of the given types.
   * @return String representation of Messages;
   */
  default String formatMessages(
      PriorityQueue<ScenarioCheckerMessage> msg, ScenarioCheckerMessageType... typeFilter) {
