...
public class GroupSourceController extends SourceController {
  ...
  /**
   * Computes random positions for ONE group based on the blockPedestrianShapes which contains the
   * shapes representing the required space for the specified group size. For each required position
   * the algorithms tries {@link GroupSourceController#NUMBER_OF_REPOSITION_TRIES} times to get a
   * feasible free position for this group.
   *
