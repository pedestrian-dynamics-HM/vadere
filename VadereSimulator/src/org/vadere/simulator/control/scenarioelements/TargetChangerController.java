 ...
 * </ul>
 */
public abstract class TargetChangerController extends ScenarioElementController implements ModelFilter {

    // Static Variables
    protected static final Logger log = Logger.getLogger(TargetChangerController.class);
    ...
    protected final Map<Integer, Agent> processedAgents;

    private Random random;
    protected TargetChangerAlgorithm changerAlgorithm;
    ...
    protected abstract void changeTargets(Agent agent);
