...
/**
 * Abstract TargetChangerAlgorithm holding the corresponding {@link TargetChanger} and {@link
 * Topography} to access during simulation update. This class is triggered by a {@link
...
public abstract class BaseTargetChangerAlgorithm implements TargetChangerAlgorithm {
  ...
  protected void checkProbabilityIsNormalized() {
    for (Double probabilityToChangeTarget :
        targetChanger.getAttributes().getProbabilitiesToChangeTarget()) {
