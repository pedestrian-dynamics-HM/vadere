...
public class GroupSourceControllerFactory extends SourceControllerFactory {
  ...
  public SourceController create(
    ...
    GroupSizeDeterminator gsd =
        new GroupSizeDeterminatorRandom(source.getAttributes().getGroupSizeDistribution(), random);
    return new GroupSourceController(
        scenario, source, dynamicElementFactory, attributesDynamicElement, random, groupModel, gsd);
  }
}
