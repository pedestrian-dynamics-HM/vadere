...
/**
 * This class encapsulates the creation of a concrete {@link IPerceptionModel} which is defined by
...
public class PerceptionModelBuilder {
  ...
  public static IPerceptionModel instantiateModel(final ScenarioStore scenarioStore) {
    String simpleClassName =
        scenarioStore.getAttributesPsychology().getPsychologyLayer().getPerception();
    ...
    AttributesPerceptionModel attributes =
        Model.findAttributes(attributesList, perceptionModel.getAttributes().getClass());
