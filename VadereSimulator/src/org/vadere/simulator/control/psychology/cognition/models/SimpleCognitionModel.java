...
/**
 * The {@link SimpleCognitionModel} just passes the perceived stimulus to the behavioral/locomotion
      ...
      if (stimulus instanceof ChangeTarget) {
        ...
        throw new IllegalArgumentException(
            String.format(
                ...
                stimulus.getClass().getSimpleName(), this.getClass().getSimpleName()));
      }
