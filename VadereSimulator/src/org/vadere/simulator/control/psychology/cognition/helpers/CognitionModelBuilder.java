...
/**
 * This class encapsulates the creation of a concrete {@link ICognitionModel} which is defined by
 * the user in the JSON scenario description.
 *
 * <p>The user provides the simple class name in the JSON scenario file. I.e., no fully qualified
 * classname.
 */
public class CognitionModelBuilder {
  ...
  public static ICognitionModel instantiateModel(final ScenarioStore scenarioStore) {
    String simpleClassName =
        scenarioStore.getAttributesPsychology().getPsychologyLayer().getCognition();
    ...
    List<Attributes> attributes =
        scenarioStore.getAttributesPsychology().getPsychologyLayer().getAttributesModel();
    ...
    AttributesCognitionModel attributesCognitionModel =
        Model.findAttributes(attributesList, cognitionModel.getAttributes().getClass());
