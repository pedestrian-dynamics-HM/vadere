 ...
 * created, containing the standard log output. This Class will collect the logging and write it to
 * the given file if needed. To remove duplicate code, the {@link #last()} method returns the last
 * added log statement to be used for the logging framework.
 */
