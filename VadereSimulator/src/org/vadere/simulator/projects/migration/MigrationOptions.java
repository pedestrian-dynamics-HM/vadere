...
public class MigrationOptions {
  ...
  private static final String legacyExtensionDefault = "legacy";
  private static final String nonmigratabelExtensionDefault = "nonmigratable";
