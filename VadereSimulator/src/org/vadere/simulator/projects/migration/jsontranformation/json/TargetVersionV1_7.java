 ...
 *
 * <p>Move "scenario.attributesSimulation.usePsychologyLayer" to this new node.
 *
 * <p>This new node "scenario.attributesPsychology" holds also the newly introduced
 * "AttributesPsychologyLayer" which is populated with default values when the migration assistant
 * runs.
 *
 * <p>The final JSON looks like this then:
 *
 * <p>{ "name" : "ScenarioName", ... "scenario" : { "attributesSimulation": { ... },
 * "attributesPsychology": { "usePsychologyLayer": true, "psychologyLayer": { "perception":
 * "SimplePerceptionModel", "cognition": "CooperativeCognitionModel" } }, ... } }
 */
