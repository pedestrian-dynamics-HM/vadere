...
public class TargetVersionV0_10 extends SimpleJsonTransformation {
  ...
  public JsonNode addUseSalientBehaviorToAttributesSimulation(JsonNode scenarioFile)
  ...
  public JsonNode addAttributesToAttributesAgent(JsonNode scenarioFile) throws MigrationException {
    JsonNode attributesPedestrian =
        pathMustExist(scenarioFile, "scenario/topography/attributesPedestrian");
