...
/**
 * Rename following pedestrian attributes: - "targetOrientationAngleThreshold" to
 * "walkingDirectionSameIfAngleLessOrEqual" - "angleCalculationType" to
 * "walkingDirectionCalculation" Also adapt possible values for "walkingDirectionCalculation". -
...
public class TargetVersionV1_6 extends SimpleJsonTransformation {
  ...
  private void renameInTopographyUnderAttributesPedestrian(
      JsonNode node, String oldName, String newName) throws MigrationException {
    JsonNode attributesPedestrianNode =
        pathMustExist(node, "scenario/topography/attributesPedestrian");
  ...
  private void renameInTopographyUnderAttributesCar(JsonNode node, String oldName, String newName)
  ...
  private void renameInMainModel(JsonNode node, String oldName, String newName)
      throws MigrationException {
    JsonNode attributesModelNode =
        path(node, "scenario/attributesModel/org.vadere.state.attributes.scenario.AttributesCar");
  ...
  private void renameInDynamicElements(JsonNode node, String oldName, String newName)
      throws MigrationException {
    JsonNode dynamicElementsNode = path(node, "scenario/topography/dynamicElements");
  ...
  private void adaptValuesForWalkingDirectionCalculation(JsonNode parent)
      throws MigrationException {
