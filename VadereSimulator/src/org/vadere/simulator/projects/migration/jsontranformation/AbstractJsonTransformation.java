...
public abstract class AbstractJsonTransformation implements JsonTransformation, JsonNodeExplorer {
  protected static final Logger logger = Logger.getLogger(AbstractJsonTransformation.class);
  ...
  public static JsonTransformation get(Version currentVersion) throws MigrationException {
    if (currentVersion.equalOrSmaller(Version.UNDEFINED))
      throw new MigrationException(
          "There is now Transformation for Version " + Version.UNDEFINED.toString());
    ...
    try {
      ...
      throw new MigrationException(
          "Cannot find Transformation in Factory for Version "
              + currentVersion.nextVersion().label());
    }
    return ret;
  }
  ...
  @Override
  public abstract JsonNode applyTransformation(JsonNode node) throws MigrationException;

  protected abstract void initDefaultHooks();

  public abstract Version getTargetVersion();
  ...
  public static void putObject(
      LinkedHashMap<Object, Object> target,
  ...
  private JsonNode sort_since_V1_14(JsonNode node) {
    ...
    putObject(
        ...
        AttributesSimulation.JSON_KEY,
        AttributesPsychology.JSON_KEY,
        AttributesStrategyModel.JSON_KEY,
        "topography",
        "stimulusInfos");
  ...
  /**
   * This hook will ensure that new attributes will be added with their default values. Important:
   * must be used as PostHook only. The JsonNode representation of the scenario must already have
