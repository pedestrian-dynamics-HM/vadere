...
public class JsonTransformation_Default extends AbstractJsonTransformation {
   ...
   * classes such as VZtoVY is not needed. This Transformation does not need
   * a @MigrationTransformation annotation because it is added to the the {@link
  ...
  private void setTargetVersion(JsonNode node, boolean beforeTransformation)
    ...
    if (currentVersion == null) {
      throw new MigrationException(
          String.format(
              "Version string: %s in scenario does not match any valid version labels: %s",
