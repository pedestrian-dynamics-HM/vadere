...
public class AttributesPotentialCompactVSosmIncident extends Incident {
  ...
  public void resolve(Tree graph, StringBuilder log) throws MigrationException {
    ...
    Tree.Node attributesOSMnode =
        graph.getNodeByPath(path("vadere", "attributesModel", AttributesOSM.class.getName()));

    if (attributesOSMnode != null) {
      JsonNode attributesOSMjsonNode = attributesOSMnode.getJsonNode();

      Tree.Node attributesPotentialCompactNode =
          graph.getNodeByPath(
              path("vadere", "attributesModel", AttributesPotentialCompact.class.getName()));
      Tree.Node attributesPotentialOSMnode =
          graph.getNodeByPath(
              path("vadere", "attributesModel", AttributesPotentialOSM.class.getName()));
      ...
      if (attributesPotentialCompactNode != null) {
        ((ObjectNode) attributesOSMjsonNode)
            .put("pedestrianPotentialModel", PotentialFieldPedestrianCompact.class.getName());
        ((ObjectNode) attributesOSMjsonNode)
            .put("obstaclePotentialModel", PotentialFieldObstacleCompact.class.getName());
      ...
      if (attributesPotentialOSMnode != null) {
        ((ObjectNode) attributesOSMjsonNode)
            .put("pedestrianPotentialModel", PotentialFieldPedestrianOSM.class.getName());
        ((ObjectNode) attributesOSMjsonNode)
            .put("obstaclePotentialModel", PotentialFieldObstacleOSM.class.getName());
