...
public abstract class MigrationAssistant {
   ...
   */
  public abstract String migrateScenarioFile(Path scenarioFilePath, Version targetVersion)
      throws MigrationException;
   ...
   * @throws MigrationException
   */
  public abstract void migrateScenarioFile(
      Path scenarioFilePath, Version targetVersion, Path outputFile) throws MigrationException;
