...
public class ScenarioStore {
  ...
  public ScenarioStore(
      ...
      final List<Attributes> attributesModel,
    ...
    this(
        ...
        new AttributesPsychology(),
        topography,
        new StimulusInfoStore());
  }
  ...
  public ScenarioStore(
      ...
      final List<Attributes> attributesModel,
      final AttributesSimulation attributesSimulation,
      final AttributesPsychology attributesPsychology,
      final Topography topography,
      final StimulusInfoStore stimulusInfoStore) {
    this.name = name;
  ...
  public void setStimulusInfoStore(StimulusInfoStore stimulusInfoStore) {
    this.stimulusInfoStore = stimulusInfoStore;
  }
