...
public class TimestepPedestriansNearbyIdKey implements DataKey<TimestepPedestriansNearbyIdKey> {
  ...
  public String[] toStrings() {
    return new String[] {
      Integer.toString(timeStep), Integer.toString(pedId1), Integer.toString(pedId2)
    };
  }
  ...
  public boolean isContinuationOf(PedestriansNearbyData other, int toleranceTimesteps) {
    return other.getPedId1() == getPedId1()
        ...
        && (other.getStartTimestep() + other.getDurationTimesteps() + toleranceTimesteps
            >= getTimeStep());
  }
  ...
  public boolean equals(Object o) {
    ...
    return timeStep == that.timeStep
        && ((pedId1 == that.pedId1 && pedId2 == that.pedId2)
            || (pedId2 == that.pedId1 && pedId1 == that.pedId2));
  }
