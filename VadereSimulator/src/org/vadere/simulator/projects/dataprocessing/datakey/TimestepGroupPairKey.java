...
public class TimestepGroupPairKey implements DataKey<TimestepGroupPairKey> {
  ...
  public static String[] getHeaders() {
    return new String[] {TimestepKey.getHeader(), "GroupId", "Pedestrian1", "Pedestrian2"};
  }
  ...
  public String[] toStrings() {
    return new String[] {
      ...
      Integer.toString(pedFirst),
      Integer.toString(pedSecond)
    };
  }
    ...
    if (timestep == o.timestep) { // order by timestep
      if (groupId == o.groupId) { // oder by groupId
        if (pedFirst == o.pedFirst && pedSecond == o.pedSecond) { // (3,4) == (3,4)
          ...
          return (pedFirst != o.pedFirst)
              ? Integer.compare(pedFirst, o.pedSecond)
              : Integer.compare(pedSecond, o.pedSecond);
        }
      } else {
