...
public final class OutputPresets {
  ...
  public OutputDefinitionStore buildDefault() {
    ...
    processor2.setType(
        "org.vadere.simulator.projects.dataprocessing.processor.FootStepTargetIDProcessor");
    processor2.setId(2);
    defaultPreset.addProcessor(processor2);

    OutputFileStore outputFile = new OutputFileStore();
    outputFile.setType(
        "org.vadere.simulator.projects.dataprocessing.outputfile.EventtimePedestrianIdOutputFile");
  ...
  public OutputDefinitionStore withOverlapProcessor() {
    ...
    outputFileOverlapCount.setType(
