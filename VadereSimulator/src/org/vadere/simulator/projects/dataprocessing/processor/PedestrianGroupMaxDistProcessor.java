...
/** */
@DataProcessorClass
public class PedestrianGroupMaxDistProcessor
    extends DataProcessor<TimestepPedestrianIdKey, MaxCentroidGroupDistData>
                        ...
                        group
                            ...
                            .forEach(
                                ped -> { // for each member in group
                                  this.putValue(
                                      new TimestepPedestrianIdKey(timeStep, ped.getId()),
