...
/**
 * Saves the maximum of the Voronoi density over the whole simulation time -> scalar output. Used
 * for UQ analysis.
 */
@DataProcessorClass()
public class MaxAreaDensityVoronoiProcessor extends NoDataKeyProcessor<Double> {
  ...
  public void init(final ProcessorManager manager) {
    super.init(manager);
    AttributesMaxAreaDensityVoronoiProcessor att =
        (AttributesMaxAreaDensityVoronoiProcessor) this.getAttributes();
    this.areaDensityVoronoiProcessor =
