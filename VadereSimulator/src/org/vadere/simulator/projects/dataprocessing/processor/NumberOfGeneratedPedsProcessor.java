  ...
  protected void doUpdate(SimulationState state) {
    ...
    if (t + 1e-7 >= getAttributes().getStartTime() && t - 1e-7 <= getAttributes().getEndTime()) {
      ...
      if (this.getPedsIds() == null) {
        ...
        List<Integer> list =
            new ArrayList<Integer>(CollectionUtils.disjunction(newPedIds, oldPedIds));
      ...
      double poissonParameter =
          numAgentsGen / state.getScenarioStore().getAttributesSimulation().getSimTimeStepLength();
