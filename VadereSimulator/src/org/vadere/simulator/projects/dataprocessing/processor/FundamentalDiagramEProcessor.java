...
public class FundamentalDiagramEProcessor extends AreaDataProcessor<Pair<Double, Double>>
  ...
  public void init(final ProcessorManager manager) {
    super.init(manager);
    AttributesFundamentalDiagramEProcessor att =
        (AttributesFundamentalDiagramEProcessor) this.getAttributes();
  ...
  protected void doUpdate(SimulationState state) {
    putValue(
        ...
        Pair.of(sumVoronoiAlgorithm.getVelocity(state), sumVoronoiAlgorithm.getDensity(state)));
  }
