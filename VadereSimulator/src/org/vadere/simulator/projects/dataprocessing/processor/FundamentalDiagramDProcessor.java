 ...
 * <tt>density</tt> and the <tt>velocity</tt> defined by the Voronoi-diagram where the points are
 * the pedestrian positions. The density is equal to the sum of areas of all Voronoi-cells
 ...
 * intersecting the <tt>measurementArea</tt> divided by the <tt>measurementArea</tt>.
 *
 * <p>For more details see zhang-2011 (doi:10.1088/1742-5468/2011/06/P06004) Method D.
 *
...
public class FundamentalDiagramDProcessor extends AreaDataProcessor<Pair<Double, Double>>
  ...
  public void init(final ProcessorManager manager) {
    super.init(manager);
    AttributesFundamentalDiagramDProcessor att =
        (AttributesFundamentalDiagramDProcessor) this.getAttributes();
    ...
    MeasurementArea voronoiMeasurementArea =
        manager.getMeasurementArea(att.getVoronoiMeasurementAreaId(), true);

    integralVoronoiAlgorithm =
        new IntegralVoronoiAlgorithm(
