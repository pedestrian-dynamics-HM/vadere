...
/**
 * This processor stores the number of pedestrians alive in the scene for every timeStep given by
 * the real simulation time.
 *
 * @author Ludwig Jaeck
 */
public class PedestrianElementCountingProcessor extends DataProcessor<EventTimeKey, Integer> {
  ...
  protected void doUpdate(SimulationState state) {
    var numberOfPeds = state.getTopography().getPedestrianDynamicElements().getElements().size();
