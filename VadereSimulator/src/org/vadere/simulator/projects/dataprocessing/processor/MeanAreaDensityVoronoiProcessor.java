...
/**
 * Saves the mean of the Voronoi density over the whole simulation time -> scalar output. Used for
 * UQ analysis.
 */
@DataProcessorClass()
public class MeanAreaDensityVoronoiProcessor extends NoDataKeyProcessor<Double> {
  ...
  public void postLoop(final SimulationState state) {
    ...
    OptionalDouble meanDensity =
        this.areaDensityVoronoiProcessor
            .getData()
            .values()
            .stream()
  ...
  public void init(final ProcessorManager manager) {
    super.init(manager);
    AttributesMeanAreaDensityVoronoiProcessor att =
        (AttributesMeanAreaDensityVoronoiProcessor) this.getAttributes();
    this.areaDensityVoronoiProcessor =
        (AreaDensityVoronoiProcessor)
            manager.getProcessor(att.getPedestrianAreaDensityVoronoiProcessorId());
  }
