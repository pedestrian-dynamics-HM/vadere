...
import org.vadere.state.attributes.processor.AttributesAreaMeanGroupDistanceProcessor;
...
@DataProcessorClass(label = "AreaMeanGroupDistanceProcessor")
public class AreaMeanGroupDistanceProcessor extends AreaDataProcessor<Double> implements CompoundObjectProvider{

        public AreaMeanGroupDistanceProcessor() {
            super("areaMeanGroupDistance");
            setAttributes(new AttributesAreaMeanGroupDistanceProcessor());
        }
