...
@DataProcessorClass()
public class FootStepMostImportantStimulusProcessor
    extends DataProcessor<EventtimePedestrianIdKey, String> {
  ...
  public void doUpdate(final SimulationState state) {
    ...
    for (Pedestrian p : pedestrians) {
      ...
      for (FootStep fs : traj.getFootSteps()) {
        this.putValue(
            new EventtimePedestrianIdKey(fs.getStartTime(), p.getId()), mostImportantStimulus);
      }
    }
  }
}
