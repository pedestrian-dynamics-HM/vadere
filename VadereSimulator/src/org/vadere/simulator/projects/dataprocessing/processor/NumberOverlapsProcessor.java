...
/**
 * This processor counts the number of overlaps during a simulation run. The is commented code that
 * can be used to show a info box if overlaps occured.
 *
 * @author Marion Gödel
 */
@DataProcessorClass()
public class NumberOverlapsProcessor extends NoDataKeyProcessor<Long> {
  ...
  public void init(final ProcessorManager manager) {
    super.init(manager);
    AttributesNumberOverlapsProcessor att =
        (AttributesNumberOverlapsProcessor) this.getAttributes();
    this.pedOverlapProc =
