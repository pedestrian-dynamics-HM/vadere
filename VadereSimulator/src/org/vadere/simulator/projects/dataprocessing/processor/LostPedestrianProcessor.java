...
@DataProcessorClass()
public class LostPedestrianProcessor
    extends DataProcessor<TimestepPedestrianIdKey, Pair<Boolean, Double>> implements ModelFilter {
    ...
    for (Pedestrian ped : pedestrians) {
      if (ped instanceof PedestrianOSM) {
        ...
        this.putValue(
            ...
            Pair.of(lost, ((PedestrianOSM) ped).getDesiredSpeed()));
      }
    }
  }
