...
@DataProcessorClass()
public class FootStepGroupSizeProcessor extends DataProcessor<EventtimePedestrianIdKey, Integer>
  ...
  public String[] toStrings(EventtimePedestrianIdKey key) {
    ...
    if (i == null) {
      logger.warn(
          String.format(
              "FootStepGroupSizeProcessor does not have Data for Key: %s", key.toString()));
      i = -1;
    }
