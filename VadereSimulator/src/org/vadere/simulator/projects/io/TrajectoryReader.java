 ...
 *
 * <p>Output file assumptions: The TrajectoryReader assumes that the first row of the output is the
 * headline and that there exist certain columns named: (id or pedestrianId) [mandatory], simTime
 * [mandatory], startX [mandatory], startY [mandatory], endX [mandatory], endY [mandatory], targetId
 * [optional] and groupId [optional]. The order of the rows (expect for the first row / header) can
 * be arbitrary. Columns has to be separated by {@link TrajectoryReader#SPLITTER} and {@link
 * OutputFile#headerProcSep}.
 */
public class TrajectoryReader {
  ...
  public Table readFile() throws IOException {
    CsvReadOptions options =
        CsvReadOptions.builder(trajectoryFilePath.toFile())
            .separator(SPLITTER)
            .header(true)
            .build();
