...
/**
 * This class encapsulates the creation of a concrete {@link INavigation} which is defined by the
 * user in the JSON scenario description.
 *
...
public class NavigationBuilder {
  ...
  public static INavigation instantiateModel(
      String simpleClassName, PedestrianBHM pedestrianBHM, Topography topography, Random random) {
