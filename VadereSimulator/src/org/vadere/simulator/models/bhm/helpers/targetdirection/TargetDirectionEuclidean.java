...
/**
 * Computes the target direction for a target which is defined by exactly one shape using the
 * Euclidean distance. This will NOT incorporate any obstacles between the current pedestrian
 * position and the target shape.
 *
