 ...
 *
 * <p>The ring consists of two circles and is used to simulate the experiment described in
 * jelic-2012 and jelic-2012b: ____ / __ \ / / \ \ \ \__/ / \____/
 */
@ModelClass
public class PotentialFieldObstacleRingExperiment implements PotentialFieldObstacle {
  ...
  public double getObstaclePotential(IPoint pos, Agent pedestrian) {
    ...
    if (distanceCenterToPoint < radiusInnerCircle || distanceCenterToPoint > radiusOuterCircle) {
      ...
      double distancePointToTrajectory1 =
          Math.abs(distanceCenterToPoint - attributes.getPedestrianTrajectory1());
      double distancePointToTrajectory2 =
          Math.abs(distanceCenterToPoint - attributes.getPedestrianTrajectory2());
      ...
      if (distancePointToTrajectory1 > allowedTrajectoryWidth
          && distancePointToTrajectory2 > allowedTrajectoryWidth) potential = 100000;
    }
  ...
  public PotentialFieldObstacle copy() {
    PotentialFieldObstacleRingExperiment potentialFieldObstacleRingExperiment =
        new PotentialFieldObstacleRingExperiment();
