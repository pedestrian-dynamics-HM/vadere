...
public class PredicateEdgeRefineCurvature<V extends IVertex, E extends IHalfEdge, F extends IFace>
    implements Predicate<V> {

  private MeshEikonalSolverFMMRefined<V, E, F> solver;
  private double maxCurvature;

  public PredicateEdgeRefineCurvature(
      @NotNull final MeshEikonalSolverFMMRefined<V, E, F> solver, final double maxCurvature) {
  ...
  public boolean test(V v) {
    double[] result =
        GeometryUtilsMesh.curvature(solver.getMesh(), v, vertex -> solver.getPotential(vertex));
