 ...
 */
public class MeshEikonalSolverFMM<V extends IVertex, E extends IHalfEdge, F extends IFace>
   ...
   * @param timeCostFunction the time cost function t(x). Note F(x) = 1 / t(x).
   * @param triangulation the triangulation the propagating wave moves on.
   * @param initialVertices Points where the propagating wave starts i.e. points that are part of
   *     the target area.
   */
  public MeshEikonalSolverFMM(
      @NotNull final String identifier,
   ...
   * @param timeCostFunction the time cost function t(x). Note F(x) = 1 / t(x).
   * @param triangulation the triangulation the propagating wave moves on.
   * @param initialVertices vertices which are part of the triangulation where the propagating wave
