...
/**
 * This class computes the traveling time T using the (single threaded) Fast Iterative Method for
 * arbitrary triangulated meshes. The quality of the result depends on the quality of the
 * triangulation. For a high accuracy the triangulation should not contain too many non-acute
 * triangles.
 *
 ...
 */
public class MeshEikonalSolverFIM<V extends IVertex, E extends IHalfEdge, F extends IFace>
