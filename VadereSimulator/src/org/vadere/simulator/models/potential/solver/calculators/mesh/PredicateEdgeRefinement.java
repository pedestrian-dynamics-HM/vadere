...
public class PredicateEdgeRefinement<V extends IVertex, E extends IHalfEdge, F extends IFace>
      ...
      for (E edge : solver.getMesh().getEdgeIt(vertex)) {
        double[] curvatures =
            GeometryUtilsMesh.curvature(
                solver.getMesh(), v -> solver.getPotential(v), v -> solver.isBurned(v), edge);
