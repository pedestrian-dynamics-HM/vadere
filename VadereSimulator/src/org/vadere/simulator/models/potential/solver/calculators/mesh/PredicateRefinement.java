 ...
 *     <p>This predicate decides if a mesh should be further refined. It compares the curvature of
 *     the travel time of the propagating wave front of the previous iteration. Compare PhD thesis
 *     B. Zoennchen Section 9.4.3.
 */
public class PredicateRefinement<V extends IVertex, E extends IHalfEdge, F extends IFace>
  ...
  public boolean test(E e) {
    ...
    double curvature =
        backgroundMesh.getInterpolatedValue(
            p.getX(), p.getY(), MeshEikonalSolverFMMIterative.nameCurvature);
