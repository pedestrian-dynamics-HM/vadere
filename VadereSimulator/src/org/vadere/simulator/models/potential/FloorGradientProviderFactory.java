...
public class FloorGradientProviderFactory {
  ...
  public static GradientProvider createFloorGradientProvider(
      GradientProviderType type,
      Domain domain,
      Map<Integer, Target> targets,
      IPotentialFieldTargetGrid potentialField) {
    ...
    switch (type) {
      case FLOOR_EIKONAL_DISCRETE:
        result =
            new FloorGradientProviderDiscrete(
                potentialField.getCellGrids(), domain.getTopography().getBounds(), targetIds);
        break;
      ...
      case FLOOR_EUCLIDEAN_CONTINUOUS_MOLLIFIED:
        result = new FloorGradientProviderEuclideanMollified(targetShapesWithId);
        break;
      default:
        break;
    }
