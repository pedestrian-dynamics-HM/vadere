...
/**
 * The PedestrianLoadingStrategyUnit simply returns a constant loading for each body, so each body
 * will have the same weight. This is equals to c in hartmann-2012.
 */
