...
public class PedestrianLoadingStrategyConditioned<T extends Pedestrian>
    implements IPedestrianLoadingStrategy<T> {

  private IPedestrianLoadingStrategy loadingStrategy;
  private Predicate<T> predicate;

  PedestrianLoadingStrategyConditioned(
      final IPedestrianLoadingStrategy loadingStrategy, final Predicate<T> predicate) {
