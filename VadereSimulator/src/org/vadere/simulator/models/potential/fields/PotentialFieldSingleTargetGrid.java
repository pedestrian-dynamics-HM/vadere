...
/**
 * A IPotentialTargetGrid, that creates for a single target the a floor field based on the
...
public class PotentialFieldSingleTargetGrid extends PotentialFieldTargetGrid {
  ...
  public PotentialFieldSingleTargetGrid(
      final Domain domain,
  ...
  protected void addEikonalSolver(final int targetId, final List<VShape> shapes) {
    if (targetId == this.targetId) {
      EikonalSolver eikonalSolver =
          IPotentialField.create(
              domain, targetId, shapes, this.attributesPedestrian, this.attributesFloorField);
