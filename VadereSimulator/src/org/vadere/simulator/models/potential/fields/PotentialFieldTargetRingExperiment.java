...
public class PotentialFieldTargetRingExperiment implements IPotentialFieldTargetGrid {
   ...
   *
   * <p>Therefore, calculate the vector centerToPedestrian = pedestrian - center (of ring). Rotate
   * this vector by 90 degree (counter-clockwise) to get the tangent vector to the circle.
