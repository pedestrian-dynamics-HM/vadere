 ...
 *
 */
public abstract class APotentialFieldTargetGrid implements IPotentialFieldTargetGrid {

    private static Logger logger = LogManager.getLogger(APotentialFieldTargetGrid.class);
    ...
    public APotentialFieldTargetGrid(final Topography topography) {
     ...
     */
    protected abstract void addEikonalSolver(final int targetId, final List<VShape> shapes);
