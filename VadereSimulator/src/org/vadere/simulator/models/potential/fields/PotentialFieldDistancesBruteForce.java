...
public class PotentialFieldDistancesBruteForce implements IPotentialField {
	...
	public PotentialFieldDistancesBruteForce(@NotNull final Collection<VShape> obstacles,
		...
		this.cellGrid = new CellGrid(bounds.getWidth(), bounds.getHeight(), 1.0/*attributesFloorField.getPotentialFieldResolution()*/, new CellState(), bounds.getMinX(), bounds.getMinY());
