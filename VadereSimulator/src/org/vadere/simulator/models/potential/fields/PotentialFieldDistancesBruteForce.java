...
public class PotentialFieldDistancesBruteForce implements IPotentialField {
	...
	public PotentialFieldDistancesBruteForce(@NotNull final Collection<VShape> obstacles,
		...
		this.cellGrid = new CellGrid(bounds.getWidth(), bounds.getHeight(), 0.5/*attributesFloorField.getPotentialFieldResolution()*/, new CellState(), bounds.getMinX(), bounds.getMinY());
