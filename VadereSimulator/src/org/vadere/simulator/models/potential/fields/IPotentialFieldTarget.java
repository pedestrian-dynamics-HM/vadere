...
/**
 * A static (needsUpdate returns always false) or dynamic target potential field for some agents,
 * i.e. multiple targets: ((x,y), agent) -> potential.
 *
...
public interface IPotentialFieldTarget extends IPotentialField, Model {
  ...
  /**
   * Returns a copy of the IPotentialField of the current state such that an update (in case of a
   * dynamic potential field) does not effect the returned copy.
   *
