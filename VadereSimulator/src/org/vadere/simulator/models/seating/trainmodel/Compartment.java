...
public class Compartment {
  ...
  public Compartment(
      ...
      int index,
      List<Target> compartmentTargets,
      List<List<Target>> seatRows,
  ...
  private void addCompartment(int nSeatGroups) {
    for (int i = 0; i < nSeatGroups; i++) addNewSeatGroup(i);
  }
  ...
  /**
   * A list of the compartment's seat groups. For half-compartments, the list contains only two seat
   * groups.
   */
