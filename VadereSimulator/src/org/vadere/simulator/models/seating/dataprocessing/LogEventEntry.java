...
public class LogEventEntry {
  ...
  public LogEventEntry(
      String time, String eventType, Integer personId, Integer seatNumber, int surveyId) {
  ...
  public String[] toStrings() {
    String[] arr = {
      eventType,
      stringOrNA(extraInt),
      stringOrNA(extraString),
      stringOrNA(personId),
      stringOrNA(seatNumber),
      stringOrNA(surveyId),
      stringOrNA(time)
    };
    return arr;
  ...
  public static String[] getHeaders() {
    ...
    String[] headers = {
      "EVENT_TYPE", "EXTRA_INT", "EXTRA_STRING", "PERSON", "SEAT", "SURVEY", "TIME"
    };
    return headers;
  }
