...
public interface DynamicElementFactory {
   ...
   *
   * <p>Note: Every attribute of the given element should be cloned for each individual in this
  ...
  /**
   * Override the DynamicElement Attributes given in the topography by the values given here. Note:
   * The Attribute values come from the source and are set by the SourceController during
   * DynamicElement Creation.
   */
  <T extends DynamicElement> DynamicElement createElement(
