...
/**
 * The Class NelderMeadConvergenceChecker. The implementation of the stopping criteria from [Nelder
 * u. Mead, 1965].
 */
public class NelderMeadConvergenceChecker implements RealConvergenceChecker {
  ...
  public boolean converged(
      final int iteration, final RealPointValuePair previous, final RealPointValuePair current) {
    ...
    if (index == dimension) {
      ...
      return (value / dimension < threshold
          || iteration > maxIterations); // earlier 1000 => change to parameter
    } else {
      return true;
    }
  }
