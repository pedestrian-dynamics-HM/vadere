...
import org.vadere.util.math.optimizer.PatternSearch;
...
public class PatternSearchOptimizer implements StepCircleOptimizer {
	...
	public VPoint getNextPosition(PedestrianOSM ped, Shape reachableArea) {
		...
		PatternSearch patternSearch = new PatternSearch(circle, pos -> ped.getPotential(pos), 0.05, basePoint, circle.getRadius());
