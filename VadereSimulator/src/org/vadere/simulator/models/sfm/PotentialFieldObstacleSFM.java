...
/** Provides gradients for obstacles using the formula of the classical SFM (Helbing 1995). */
@ModelClass
public class PotentialFieldObstacleSFM implements GradientProvider, PotentialFieldObstacle {
  ...
  public void gradient(double t, int targetID, double[] x, double[] completeGrad) {
    ...
    for (Obstacle obstacle : obstacles) {
      ...
      pot =
          attributes.getObstacleBodyPotential()
              * Math.exp(-distance / attributes.getObstacleRepulsionStrength());
