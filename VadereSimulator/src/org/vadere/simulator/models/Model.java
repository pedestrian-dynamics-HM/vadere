...
/**
 * Interface for a simulation model. The <code>solve</code> method must be called before usage! This
 * interface defines a callbacks for the simulation loop. It's implementations define the major part
 * of the simulation model's logic.
 */
public interface Model {

  /**
   * This method initializes this model by selecting the appropriate attributes from the list and
   * creating sub models. It also sets attributes recursively for its sub models.
   */
  void initialize(
  ...
  static <T extends Attributes> T findAttributes(
      List<Attributes> attributesList, final Class<T> type) {
    try {
