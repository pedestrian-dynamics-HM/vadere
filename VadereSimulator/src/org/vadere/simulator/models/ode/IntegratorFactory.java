  ...
  public static FirstOrderIntegrator createFirstOrderIntegrator(
    ...
    switch (attributes.getSolverType()) {
      ...
      case DORMAND_PRINCE_83:
        ...
        break;
      case CLASSICAL_RK4:
        integrator = new ClassicalRungeKuttaIntegrator(attributes.getStepSizeMin());
        break;
      case EULER:
      ...
      case NONE:
      default:
        throw new IllegalArgumentException("No solver type specified. Aborting.");
    }
