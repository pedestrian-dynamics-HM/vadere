...
/**
 * ThresholdResponseModel describes a <code>Pedestrian</code>'s probability of infection, more
 * precisely its {@link ThresholdResponseModelInfectionStatus}.
 *
 * <p>It can be included in the simulation by adding it to the list of <code>submodels</code> in the
 * scenario file. This requires that an exposure model is defined.
 *
 * <p>The probability of infection is 0 by default but set to 1 if the <code>Pedestrian</code>'s
 * degree of exposure {@link ExposureModelHealthStatus} reaches or exceeds a user-defined threshold.
 * The threshold is defined by {@link AttributesThresholdResponseModel}.
 */
@ModelClass
public class ThresholdResponseModel extends AbstractDoseResponseModel {
  ...
  public void initialize(
    ...
    this.attributesThresholdResponseModel =
        Model.findAttributes(attributesList, AttributesThresholdResponseModel.class);
            ...
            .filter(
                pedestrian ->
                    pedestrian.getDegreeOfExposure()
                        >= attributesThresholdResponseModel.getExposureToInfectedThreshold())
  ...
  @Override
  protected Pedestrian topographyControllerEvent(
