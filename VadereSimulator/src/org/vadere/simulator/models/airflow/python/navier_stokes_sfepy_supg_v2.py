...
from vadere_helpers_v2 import extract_attributes, get_parameter_string
...
def main():
    ...
    np.savetxt(args.scenario + '_' + args.hash + '_Vx.txt', Vx_raw,
               header=f'{Vx_raw.shape[0]}_1_{parameter_string}')
    np.savetxt(args.scenario + '_' + args.hash + '_Vy.txt', Vy_raw,
    ...
    plot_results(display_mesh, grid_x, grid_y, Vx_grid, Vy_grid, vel_mag, geom_data["obstacles"])
