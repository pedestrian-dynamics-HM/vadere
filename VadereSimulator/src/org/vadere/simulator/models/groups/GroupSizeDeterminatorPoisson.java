...
/**
 * The Distribution of the generated group sizes is a zero truncated Poisson distribution with mean
 * lambda.
 */
public class GroupSizeDeterminatorPoisson implements GroupSizeDeterminator {
  ...
  public GroupSizeDeterminatorPoisson(double lambda, Random random) {
    ...
    if (lambda < 1) {
      throw new IllegalArgumentException("lambda must not be smaller than 1.");
    }
