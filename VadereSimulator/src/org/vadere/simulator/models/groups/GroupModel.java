 ...
 *
 * <p>At the time a pedestrian is placed in the topography the {@link GroupModel} is triggered over
 * the {@link DynamicElementAddListener} and will assign the pedestrian to a group based on the
 * source.
 *
 * @param <T> Group Type
 */
