...
public class DistanceFunction {
	...
	private static void bruteForce() throws IOException {
		...
		DistanceFunctionApproxBF distanceFunctionApproxBF = new DistanceFunctionApproxBF(pslg, IDistanceFunction.create(pslg.getSegmentBound(), pslg.getHoles()), PTriangleMeshBuilder::new);
