...
public class PointToPedestrianConverter {
  ...
  /**
   * Converts a collection of points into a list of pedestrians. The only thing that is set is the
   * position of the pedestrian, all other values will be equals the default values. Pedestrians may
   * overlap themselves!
   *
  ...
  /**
   * Converts a array of points into a list of pedestrians. The only thing that is set is the
   * position of the pedestrian, all other values will be equals the default values. Pedestrians may
   * overlap themselves!
   *
