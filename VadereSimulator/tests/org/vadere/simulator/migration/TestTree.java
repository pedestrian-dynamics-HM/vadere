...
public class TestTree {
  ...
  public void setUp() throws Exception {
    json =
        "{\"test\": 1.0, \"persons\":[{\"name\":\"hans\", \"age\": 24},{\"name\":\"bene\", \"age\": 25}], \"house\": {\"street\":\"forest street\", \"number\": 3} }";
  }
  ...
  public void testRecursiveScan() throws IOException, MigrationException {
    ...
    assertEquals(
        "number",
        tree.recursiveScan(tree.getRoot(), "house", "number", new ExceptionIncident(jsonNode))
            .get(0)
            .getKey());
    tree.deleteUnrecognizedField(
        "house", "number", new StringBuilder(), new ExceptionIncident(jsonNode));
    assertEquals(
        new LinkedList<>(),
        tree.recursiveScan(tree.getRoot(), "house", "number", new ExceptionIncident(jsonNode)));
  }
