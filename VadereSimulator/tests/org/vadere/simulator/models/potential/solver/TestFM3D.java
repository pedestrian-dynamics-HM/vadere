...
/**
 * Tests the {@link PotentialFieldCalculatorFastMarching3D} class. Note that the tests are not
 * automatic, this class only generates files that need to be checked visually with the MATLAB files
...
public class TestFM3D {
   ...
   * org.vadere.simulator.models.potential.solver.calculators.PotentialFieldCalculatorFastMarching3D#recalculate(double[][][],
