...
public class ProximityExposureModelTest {
  ...
  public void testInitialize() {
    Assert.assertEquals(
        attributesList.get(0), proximityExposureModel.attributesProximityExposureModel);
  }
  ...
  public double testUpdate(boolean infectiousAgentPresent) {
    double maxExposureRadius =
        proximityExposureModel.attributesProximityExposureModel.getExposureRadius();
  ...
  public void testUpdatePedestrianDegreeOfExposure() {
    ...
    Assert.assertEquals(
        expectedDegreeOfExposure, pedestrian.getDegreeOfExposure(), ALLOWED_DOUBLE_TOLERANCE);
  }
  ...
  public void testTopographyControllerEventDefinesInfectiousPedestrian() {
    int pedestrianId = 1;
    proximityExposureModel.attributesProximityExposureModel.addInfectiousPedestrianIdsNoSource(
        pedestrianId);
    Agent agent = new Pedestrian(new AttributesAgent(pedestrianId), rdm);

    Pedestrian pedestrian =
        proximityExposureModel.topographyControllerEvent(
