...
public class TestTrainModel {
  ...
  public void testAllSeatTargetsAreDistinct() {
    ...
    final int distinctTargetCount =
        (int) seats.stream().map(s -> s.getAssociatedTarget()).distinct().count();
  ...
  public void testAllCompartmentTargetsAreDistinct() {
    ...
    final int distinctTargetCount = (int) compartmentTargets.stream().distinct().count();
  ...
  public void testGetEntranceAreaIndexForPerson() {
    ...
    for (Source s : trainModel.getAllDoorSources()) {
      p.setSource(s);
      assertEquals(
          trainModel.getEntranceAreaIndexOfSource(s), trainModel.getEntranceAreaIndexForPerson(p));
    }
  }
  ...
  public void testFirstHalfCompartment() {
    ...
    assertEquals(trainModel.getCompartmentTargets().get(0), c.getCompartmentTarget());
  }
  ...
  public void testLastHalfCompartment() {
    ...
    assertEquals(
        trainModel.getCompartmentTargets().get(nCompartmentTargets - 1), c.getCompartmentTarget());
  }
  ...
  public void testCompartmentTargetLocationFallInCompartment() {
    ...
    assertIsInCompartment(
        trainModel.getCompartmentTargets().get(nCompartmentTargets - 1), nCompartments - 1);
  }
  ...
  public void testGetCompartmentByTarget() {
    ...
    assertEquals(
        trainModel.getCompartment(nCompartments - 4),
        getCompartmentByCompartmentTargetIndex(nCompartmentTargets - 4));
    assertEquals(
        trainModel.getCompartment(nCompartments - 3),
        getCompartmentByCompartmentTargetIndex(nCompartmentTargets - 3));
    assertEquals(
        trainModel.getCompartment(nCompartments - 2),
        getCompartmentByCompartmentTargetIndex(nCompartmentTargets - 2));

    assertEquals(
        trainModel.getCompartment(nCompartments - 1),
        getCompartmentByCompartmentTargetIndex(nCompartmentTargets - 1));
  }
  ...
  private void assertEqualsSeatNumber(
      int expectedSeatNumber, int compartmentIndex, int seatGroupIndex, int seatIndex) {
    assertEquals(
        expectedSeatNumber,
        trainModel
            .getSeat(compartmentIndex, seatGroupIndex, seatIndex)
