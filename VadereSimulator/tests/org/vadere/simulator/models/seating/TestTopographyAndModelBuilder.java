...
public class TestTopographyAndModelBuilder {
  ...
  public static final int nCompartmentTargets =
      nCompartments; // includes 2 targets from half-compartments
  ...
  private Topography createTestTopography() {
    try {
      ...
      final String json =
          new Scanner(
                  TestTopographyAndModelBuilder.class.getResourceAsStream(
