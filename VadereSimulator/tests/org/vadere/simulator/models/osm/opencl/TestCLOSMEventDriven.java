...
public class TestCLOSMEventDriven {
  ...
  public void setUp() throws IOException, TextOutOfNodeException {
    ...
    for (int i = 0; i < numberOfElements - 1; i++) {
      ...
      CLParallelEventDrivenOSM.PedestrianOpenCL pedestrian =
          new CLParallelEventDrivenOSM.PedestrianOpenCL(randomPosition, maxStepSize);
      pedestrians.add(pedestrian);
    }

    CLParallelEventDrivenOSM.PedestrianOpenCL lastPedestrian =
        pedestrians.get(pedestrians.size() - 1);

    CLParallelEventDrivenOSM.PedestrianOpenCL pedestrian =
        new CLParallelEventDrivenOSM.PedestrianOpenCL(
            lastPedestrian.position.add(new VPoint(-0.001, -0.001)), maxStepSize);
    pedestrians.add(pedestrian);
  }
