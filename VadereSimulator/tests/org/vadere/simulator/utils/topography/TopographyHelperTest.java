...
public class TopographyHelperTest {
  ...
  public void calculateAngleBetweenTargetGradientsReturnsZeroIfTargetsAreInSameDirection() {
    ...
    double actualAngle =
        TopographyHelper.calculateAngleBetweenTargetGradients(pedestrian1, pedestrian2);
  ...
  public void calculateAngleBetweenTargetsReturnsZeroIfTargetsAreInSameDirection() {
    ...
    double actualAngle =
        TopographyHelper.calculateAngleBetweenTargets(pedestrian1, pedestrian2, topography);
  ...
  @Test
  public void
      calculateAngleBetweenTargetsReturnsCorrectResultIfPedestrian1UsesAngleCalculationTypeUseCenter() {
    ...
    double expectedAngle =
        Math.PI - Math.atan2(centerOfTarget1Rectangle.y, centerOfTarget1Rectangle.x);
    double actualAngle =
        TopographyHelper.calculateAngleBetweenTargets(pedestrian1, pedestrian2, topography);

    // It seems that "Math.atan2()" is not as precise as expected. Therefore, increase the allowed
    // tolerance.
  ...
  @Test
  public void
      calculateAngleBetweenTargetsReturnsCorrectResultIfPedestrian1UsesAngleCalculationTypeUseClosestPoint() {
    // Create a topography with two targets.
    topography = new Topography();
  ...
  public void
      calculateAngleBetweenWalkingDirectionsThrowsExceptionIfByGradientIsSelectedButNoPedestrianOsm() {
    createTwoTargetsAndTwoPedestrians(
        new VPoint(1, 0), // target1
        new VPoint(1, -1), // target2
        new VPoint(0, 0), // pedestrian1
    ...
    TopographyHelper.calculateAngleBetweenWalkingDirections(
        pedestrians.get(0), pedestrian1, topography);
  }
}
