...
public class PedestrianTargetIdProcessorTestEnv
    extends ProcessorTestEnv<TimestepPedestrianIdKey, Integer> {
  ...
  public void loadDefaultSimulationStateMocks() {
    addSimState(
        new SimulationStateMock(1) {
          @Override
          public void mockIt() {
            List<Pedestrian> peds =
                getPeds(new Integer[] {12, 33, 40, 2}, new Integer[] {1, 1, 2, 2});
    ...
    addSimState(
        new SimulationStateMock(2) {
          ...
          public void mockIt() {
            List<Pedestrian> peds =
                getPeds(new Integer[] {12, 33, 40, 9}, new Integer[] {1, 2, 3, 1});
            Mockito.when(state.getTopography().getElements(Pedestrian.class)).thenReturn(peds);
