...
public class PedestrianStateProcessorTestEnv
    extends ProcessorTestEnv<TimestepPedestrianIdKey, String> {
  ...
  private void addToExpectedOutput(int step, List<Pedestrian> peds, String value) {
    peds.forEach(
        p -> super.addToExpectedOutput(new TimestepPedestrianIdKey(step, p.getId()), value));
  }
