...
public class PedestrianWaitingTimeProcessorTestEnv
    extends ProcessorTestEnv<PedestrianIdKey, Double> {
  ...
  void initializeDependencies() {
    ...
    MeasurementArea measurementArea =
        new MeasurementArea(new AttributesMeasurementArea(42, new VRectangle(0, 0, 2, 5)));
