...
public class MeanPedestrianEvacuationTimeProcessorTestEnv
    extends ProcessorTestEnv<NoDataKey, Double> {
  ...
  void initializeDependencies() {
    ...
    AttributesMeanPedestrianEvacuationTimeProcessor attr =
        (AttributesMeanPedestrianEvacuationTimeProcessor) testedProcessor.getAttributes();
