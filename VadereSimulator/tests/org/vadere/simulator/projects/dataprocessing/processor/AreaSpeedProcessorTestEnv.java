...
public class AreaSpeedProcessorTestEnv extends ProcessorTestEnv<TimestepKey, Double> {
  ...
  void initializeDependencies() {
    ...
    MeasurementArea measurementArea =
        new MeasurementArea(new AttributesMeasurementArea(99, new VRectangle(0, 0, 4, 5)));
  ...
  public void loadDefaultSimulationStateMocks() {
    ...
    addSimState(
        new SimulationStateMock(2) {
          ...
          public void mockIt() {
            ...
            b.clear()
                .add(1, new VPoint(1, 1), 1) // dist = 1.0
    ...
    addSimState(
        new SimulationStateMock(3) {
          ...
          public void mockIt() {
            ...
            b.clear()
                .add(1, new VPoint(3, 1), 2) // dist = 2.0
    ...
    addSimState(
        new SimulationStateMock(4) {
          @Override
          public void mockIt() {

            b.clear()
                .add(1, new VPoint(6, 1), 3) // not in area
    ...
    expectedOutput
        ...
        .forEach(
            e -> {
              ...
              sj.add(Integer.toString(e.getKey().getTimestep())).add(Double.toString(e.getValue()));
