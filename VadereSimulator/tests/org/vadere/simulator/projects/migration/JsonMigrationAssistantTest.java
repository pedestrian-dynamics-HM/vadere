...
public class JsonMigrationAssistantTest implements TestResourceHandlerScenario {
  ...
  public void TestTransform() throws IOException {
    ...
    String json =
        IOUtils.readTextFileFromResources(
            "/migration/testProject_v0.1/scenarios/basic_1_chicken_osm1.scenario");
    //		String json =
    // IOUtils.readTextFileFromResources("/migration/testProject_v0.1/scenarios/WithDots_basic_1_chicken_osm1.scenario");
