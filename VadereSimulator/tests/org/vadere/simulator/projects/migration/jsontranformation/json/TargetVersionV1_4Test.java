...
public class TargetVersionV1_4Test extends JsonTransformationTest {
  ...
  @Test
  public void
      assertThatJsonTransformationV1_3ToV1_4RenamesFootStepsToStoreInTopographyUnderAttributesPedestrian()
          throws MigrationException {
    String scenarioFileAsString =
        getTestFileAsString("footStepsToStoreInTopographyUnderAttributesPedestrian.scenario");
  ...
  @Test
  public void
      assertThatJsonTransformationV1_3ToV1_4RenamesFootStepsToStoreInTopographyUnderAttributesCar()
          throws MigrationException {
    String scenarioFileAsString =
        getTestFileAsString("footStepsToStoreInTopographyUnderAttributesCar.scenario");
    JsonNode oldScenarioAsJson = getJsonFromString(scenarioFileAsString);
  ...
  @Test
  public void assertThatJsonTransformationV1_3ToV1_4RenamesFootStepsToStoreInMainModel()
      throws MigrationException {
    String scenarioFileAsString = getTestFileAsString("footStepsToStoreInMainModel.scenario");
    JsonNode oldScenarioAsJson = getJsonFromString(scenarioFileAsString);

    String oldJsonPath =
        "scenario/attributesModel/org.vadere.state.attributes.scenario.AttributesCar/footStepsToStore";
    String newJsonPath =
        "scenario/attributesModel/org.vadere.state.attributes.scenario.AttributesCar/footstepHistorySize";
  ...
  @Test
  public void assertThatJsonTransformationV1_3ToV1_4RenamesFootStepsToStoreInDynamicElements()
      throws MigrationException {
