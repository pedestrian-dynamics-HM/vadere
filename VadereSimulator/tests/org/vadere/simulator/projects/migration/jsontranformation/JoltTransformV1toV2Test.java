...
public class JoltTransformV1toV2Test extends JsonTransformationTest {
  ...
  public void Test1() throws MigrationException {
    ...
    pathMustExist(
        node, "scenario/attributesModel/org.vadere.state.attributes.models.AttributesOSM");
    pathMustExist(
        node, "scenario/attributesModel/org.vadere.state.attributes.models.AttributesFloorField");
  }
