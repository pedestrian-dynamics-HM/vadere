...
public class TestScenarioBuilder {
  ...
  public void init() throws URISyntaxException, IOException {
    jsonScenario =
        IOUtils.readTextFile(
            Paths.get(
                getClass().getResource("/org/vadere/simulator/entrypoints/test.scenario").toURI()));
  }
  ...
  public void testChangeAttributes() throws IOException {
    ...
    builder.setAttributesField(
        "bounds", new VRectangle(10, 10, 100, 100), AttributesTopography.class);
    scenario = builder.build();
    ...
    scenario = builder.build();
    assertTrue(
        scenario.getTopography().getSources().get(0).getAttributes().getTargetIds().get(0) == 1);
  }
}
