...
public class TestSourceControllerUsingConstantSpawnRate extends TestSourceController {
  ...
  public void testUpdateEqualStartAndEndTime() throws IOException {
    ...
    SourceTestAttributesBuilder builder = new SourceTestAttributesBuilder().setOneTimeSpawn(0);
    initialize(builder);
        ...
        new SourceTestAttributesBuilder()
            ...
            .setSourceDim(
                new VRectangle(
                    ...
                    attributesAgent.getRadius() * 2 + 0.05)); // small source
    initialize(builder);
  ...
  protected void beamPedsAway(int source) {
    ...
    for (Pedestrian pedestrian :
        sourceTestData.get(source).topography.getElements(Pedestrian.class)) {
      pedestrian.setPosition(positionFarAway);
    }
  }
}
