...
public class GroupSourceControllerTest extends TestSourceControllerUsingConstantSpawnRate {
  ...
  private SourceControllerFactory getTestGroupFactory(
      GroupModel groupModel, GroupSizeDeterminator gsd) {
    return new SourceControllerFactory() {
      @Override
      public SourceController create(
          Topography scenario,
          Source source,
          DynamicElementFactory dynamicElementFactory,
          AttributesDynamicElement attributesDynamicElement,
          Random random) {
        return new GroupSourceController(
            scenario,
            source,
  ...
  public SourceControllerFactory getSourceControllerFactory(
      SourceTestData d, GroupSizeDeterminatorRandom gsd) {
  ...
  public void initialize(SourceTestAttributesBuilder builder) {
    ...
    d.pedestrianFactory =
        new TestDynamicElementFactory(d) {
          ...
          public <T extends DynamicElement> DynamicElement createElement(
            ...
            AttributesAgent att = new AttributesAgent(aAttr, registerDynamicElementId(null, id));
    ...
    if (builder.getGroupSizeDistributionMock().length > 0) {
      ...
      Mockito.when(gsdRnd.nextGroupSize())
          .thenReturn(
              groupSizeDistributionMock[0],
              Arrays.copyOfRange(groupSizeDistributionMock, 1, groupSizeDistributionMock.length));
    ...
    d.sourceController =
        d.sourceControllerFactory.create(
            d.topography, d.source, d.pedestrianFactory, d.attributesPedestrian, d.random);
  ...
  public void multipleSources() {
    SourceTestAttributesBuilder builder1 =
        new SourceTestAttributesBuilder()
            .setGroupSizeDistribution(0.0, 0.0, 0.25, 0.75)
    ...
    SourceTestAttributesBuilder builder2 =
        new SourceTestAttributesBuilder()
