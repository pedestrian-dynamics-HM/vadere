...
public class SimplePerceptionModelTest {
  ...
  private List<Attributes> attributesList =
      Collections.singletonList(new AttributesSimplePerceptionModel());
  ...
  public void updateSetsElapsedTimeIfNoOtherStimulusIsPresent() {
    ...
    pedestrians.forEach(
        pedestrian -> assertTrue(expectedStimulus == pedestrian.getMostImportantStimulus()));
  }
  ...
  public void updateRanksThreatHigherThanElapsedTime() {
    ...
    pedestrians.forEach(
        pedestrian ->
            assertTrue(
                expectedStimulus.getTime() == pedestrian.getMostImportantStimulus().getTime()));
  }
  ...
  private HashMap<Pedestrian, List<Stimulus>> getPedSpecififStimuli(
      List<Pedestrian> pedestrians, List<Stimulus> stimuli) {
    HashMap<Pedestrian, List<Stimulus>> pedSpecififStimuli =
        new HashMap<Pedestrian, List<Stimulus>>();
