...
public class StimulusControllerTest {
  ...
  private ScenarioStore getScenarioStore(StimulusInfoStore store) {
    return new ScenarioStore("name", "description", "mainModel", null, null, null, null, store);
  }
  ...
  public void stimulusControllerConstructorDetectsOneTimeStimuliProperly() {
    ...
    ScenarioStore scenarioStoreContainingOneOneTimeStimulus =
        getScenarioStoreContainingRecurringStimulus(isRecurringStimulus);

    StimulusController stimulusController =
        new StimulusController(scenarioStoreContainingOneOneTimeStimulus);
  ...
  public void stimulusControllerConstructorDetectsRecurringStimuliProperly() {
    ...
    ScenarioStore scenarioStoreContainingOneRecurringStimulus =
        getScenarioStoreContainingRecurringStimulus(isRecurringStimulus);

    StimulusController stimulusController =
        new StimulusController(scenarioStoreContainingOneRecurringStimulus);
  ...
  public void stimulusControllerConstructorDetectsOneTimeAndRecurringStimuliProperly() {
    ...
    oneTimeAndRecurringStimuli.addAll(
        getStimulusInfoStoreContainingRecurringStimulus(false).getStimulusInfos());
    oneTimeAndRecurringStimuli.addAll(
        getStimulusInfoStoreContainingRecurringStimulus(true).getStimulusInfos());
    ...
    ScenarioStore scenarioStoreContainingOneTimeAndRecurringStimulus =
        new ScenarioStore(
            "name",
            "description",
            "mainModel",
  ...
  @Test
  public void
      timeframeIsActiveAtSimulationTimeReturnsTrueIfSimulationTimeFallsOntoStartTimePeriodically() {
    ...
    Timeframe timeframe =
        new Timeframe(startTime, endTime, recurringStimulus, waitTimeBetweenRepetition);

    for (int i = 0; i < 50; i++) {
      double currentSimulationTime = simulationTime + (i * periodicity);

      boolean timeframeIsActive =
          StimulusController.timeframeIsActiveAtSimulationTime(timeframe, currentSimulationTime);
  ...
  @Test
  public void
      timeframeIsActiveAtSimulationTimeReturnsTrueIfSimulationTimeFallsOntoEndTimePeriodically() {
    boolean recurringStimulus = true;
    double startTime = 0.75;
    double endTime = 1.25;
    double waitTimeBetweenRepetition = 1.0;
  ...
  @Test
  public void
      timeframeIsActiveAtSimulationTimeReturnsTrueIfSimulationTimeFallsBetweenStartAndEndTimePeriodically() {
    boolean recurringStimulus = true;
    double startTime = 0.75;
    double endTime = 1.25;
    double waitTimeBetweenRepetition = 1.0;
  ...
  @Test
  public void
      timeframeIsActiveAtSimulationTimeReturnsFalseIfWaitTimeIsZeroButSimulationTimeBeforeStartTime() {
    boolean recurringStimulus = true;
    double startTime = 0.75;
    double endTime = 1.25;
  ...
  @Test
  public void
      timeframeIsActiveAtSimulationTimeReturnsTrueIfWaitTimeIsZeroAndSimulationTimeGreaterThanStartTime() {
    boolean recurringStimulus = true;
    double startTime = 0.75;
    double endTime = 1.25;
    double waitTimeBetweenRepetition = 0.0;
  ...
  @Test
  public void
      getStimuliForTimeAlwaysCreatesASingleElapsedTimeStimulusWithRequestedSimulationTime() {
    boolean isRecurringStimulus = false;
    ScenarioStore scenarioStoreContainingOneOneTimeStimulus =
        getScenarioStoreContainingRecurringStimulus(isRecurringStimulus);
    ...
    List<Stimulus> activeStimuli =
        stimulusController.getStimuliFilteredTimeOnly(expectedSimulationTime);
  ...
  public void getStimuliForTimeTimestampsEachActiveStimulus() {
    ...
    // Store one concrete one-time stimulus in "StimulusInfoStore" to check if its timestamp is
    // updated.
    Wait wait = new Wait();
    List<Stimulus> stimuli = new ArrayList<>();
    stimuli.add(wait);

    StimulusInfo activeStimulusInfo =
        scenarioStoreContainingOneOneTimeStimulus.getStimulusInfoStore().getStimulusInfos().get(0);
  ...
  public void getStimuliForTimeDoesNotTimestampInactiveStimuli() {
    ...
    StimulusInfo inactiveStimulusInfo =
        scenarioStoreContainingOneOneTimeStimulus.getStimulusInfoStore().getStimulusInfos().get(0);
  ...
  public void timeframeIsActiveAtSimulationTimeThrowExceptionIfTimeframeHasRepeatFalse() {
    StimulusController.timeframeIsActiveAtSimulationTime(new Timeframe(2, 7, false, 0), 1);
  ...
  public void getStimuliForTimeReturnsCorrectStimuli() {
    ...
    StimulusInfo stimulusInfo1 =
        getStimulusInfo(new Timeframe(2, 7, false, 0), stimulus1, stimulus2);

    StimulusInfo stimulusInfo2 = getStimulusInfo(new Timeframe(3, 4, true, 1), stimulus3);
  ...
  public void updateUsesClosestThreatForPedestrian() {
    ...
    List<Stimulus> stimuliFiltered1 =
        stimulusController.getStimuliFiltered(
            0, pedestrians.get(0).getPosition(), pedestrians.get(0).getId());
    Stimulus Threat1 =
        stimuliFiltered1
            .stream()
            .filter(stimulus -> stimulus instanceof Threat)
            .collect(Collectors.toList())
            .get(0);
    List<Stimulus> stimuliFiltered2 =
        stimulusController.getStimuliFiltered(
            0, pedestrians.get(1).getPosition(), pedestrians.get(1).getId());
    Stimulus Threat2 =
        stimuliFiltered2
            .stream()
            .filter(stimulus -> stimulus instanceof Threat)
  ...
  public void updateUsesWaitInAreaIfPedestriansStandsInWaitingArea() {
    ...
    Stimulus Wait =
        stimuliFiltered1
            .stream()
            .filter(stimulus -> stimulus instanceof Wait)
            .collect(Collectors.toList())
            .get(0);
    List<Stimulus> stimuliFiltered2 =
        stimulusController.getStimuliFiltered(
