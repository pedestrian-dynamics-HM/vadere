...
public class SimpleCognitionModelTest {
  ...
  private void testCognitionLayer(
      SelfCategory defaultSelfCategory,
      SelfCategory expectedSelfCategory,
      Stimulus presentStimulus) {
  ...
  public void updatesSetsChangeTargetOnChangeTargetStimulus() {
    testCognitionLayer(
        SelfCategory.TARGET_ORIENTED, SelfCategory.CHANGE_TARGET, new ChangeTarget());
  }

  @Test
  public void updatesSetsThreatenedOnThreatStimulus() {
    testCognitionLayer(SelfCategory.TARGET_ORIENTED, SelfCategory.THREATENED, new Threat());
  }

  @Test
  public void updatesSetsWaitOnWaitStimulus() {
    testCognitionLayer(SelfCategory.TARGET_ORIENTED, SelfCategory.WAIT, new Wait());
  }

  @Test
  public void updatesSetsWaitOnWaitInAreaStimulus() {
    testCognitionLayer(SelfCategory.TARGET_ORIENTED, SelfCategory.WAIT, new WaitInArea());
  }

  @Test
  public void updatesSetsTargetOrientedOnElapsedTime() {
    testCognitionLayer(SelfCategory.WAIT, SelfCategory.TARGET_ORIENTED, new ElapsedTime());
  }
}
