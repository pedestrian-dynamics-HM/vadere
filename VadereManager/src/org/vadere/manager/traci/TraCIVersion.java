...
public enum TraCIVersion {
  ...
  private static final String versionStringTemplate =
      "VadereTraCI-%d.%d.%d This is a TraCI Server implementing only a small subset of TraCI Version %d";
  ...
  public String getVersionString() {
    return String.format(
        versionStringTemplate, traciBaseVersion, vadereApiMajor, vadereApiMinor, traciBaseVersion);
  }
}
