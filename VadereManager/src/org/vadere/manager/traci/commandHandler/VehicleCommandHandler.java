...
public class VehicleCommandHandler extends CommandHandler<VehicleVar> {
  ...
  public TraCIGetResponse responseOK(TraCIDataType responseDataType, Object responseData) {
    return responseOK(
        responseDataType,
        responseData,
        TraCICmd.GET_VEHICLE_VALUE,
        TraCICmd.RESPONSE_GET_VEHICLE_VALUE);
  }
  ...
  public TraCICommand process_getIDList(
      TraCIGetCommand rawCmd, RemoteManager remoteManager, VehicleVar traCIVar) {
  ...
  public TraCICommand processValueSub(TraCICommand rawCmd, RemoteManager remoteManager) {
    return processValueSub(
        ...
        this::processGet,
        TraCICmd.GET_VEHICLE_VALUE,
        TraCICmd.RESPONSE_SUB_VEHICLE_VALUE);
  }
