...
public class PolygonCommandHandler extends CommandHandler<PolygonVar> {
  ...
  public TraCIGetResponse responseOK(TraCIDataType responseDataType, Object responseData) {
    return responseOK(
        responseDataType, responseData, TraCICmd.GET_POLYGON, TraCICmd.RESPONSE_GET_POLYGON);
  }
  ...
  @PolygonHandler(
    cmd = TraCICmd.GET_POLYGON,
    var = PolygonVar.TOPOGRAPHY_BOUNDS,
    name = "getTopographyBounds",
    ignoreElementId = true
  )
  public TraCICommand process_getTopographyBounds(
      TraCIGetCommand cmd, RemoteManager remoteManager, PolygonVar traCIVar) {
    remoteManager.accessState(
        (manager, state) -> {
          Rectangle2D.Double bounds = state.getTopography().getBounds();
          List<Double> dRet =
              List.of(bounds.getX(), bounds.getY(), bounds.getHeight(), bounds.getWidth());
          List<String> ret =
              dRet.stream().map(p -> Double.toString(p)).collect(Collectors.toList());
  ...
  @PolygonHandler(
    cmd = TraCICmd.GET_POLYGON,
    var = PolygonVar.ID_LIST,
    name = "getIDList",
    ignoreElementId = true
  )
  public TraCICommand process_getIDList(
      TraCIGetCommand cmd, RemoteManager remoteManager, PolygonVar traCIVar) {
  ...
  @PolygonHandler(
    cmd = TraCICmd.GET_POLYGON,
    var = PolygonVar.COUNT,
    name = "getIDCount",
    ignoreElementId = true
  )
  public TraCICommand process_getIDCount(
      TraCIGetCommand cmd, RemoteManager remoteManager, PolygonVar traCIVar) {
  ...
  public TraCICommand process_getType(
      TraCIGetCommand cmd, RemoteManager remoteManager, PolygonVar traCIVar) {
  ...
  public TraCICommand process_getShape(
      TraCIGetCommand cmd, RemoteManager remoteManager, PolygonVar traCIVar) {
    int elementID = Integer.parseInt(cmd.getElementIdentifier());
    remoteManager.accessState(
        (manager, state) -> {
  ...
  public TraCICommand process_getCentroid(
      TraCIGetCommand cmd, RemoteManager remoteManager, PolygonVar traCIVar) {
    int elementID = Integer.parseInt(cmd.getElementIdentifier());
    remoteManager.accessState(
        (manager, state) -> {
  ...
  public TraCICommand process_getColor(
      TraCIGetCommand cmd, RemoteManager remoteManager, PolygonVar traCIVar) {
  ...
  public TraCICommand process_getPosition2D(
      TraCIGetCommand cmd, RemoteManager remoteManager, PolygonVar traCIVar) {
  ...
  public TraCICommand process_getImageFile(
      TraCIGetCommand cmd, RemoteManager remoteManager, PolygonVar traCIVar) {
    cmd.setResponse(responseERR("Not Implemented"));
    return cmd;
  }
  ...
  public TraCICommand process_getImageWidth(
      TraCIGetCommand cmd, RemoteManager remoteManager, PolygonVar traCIVar) {
    cmd.setResponse(responseERR("Not Implemented"));
    return cmd;
  }
  ...
  public TraCICommand process_getImageHeight(
      TraCIGetCommand cmd, RemoteManager remoteManager, PolygonVar traCIVar) {
    cmd.setResponse(responseERR("Not Implemented"));
    return cmd;
  }
  ...
  public TraCICommand process_getImageAngle(
      TraCIGetCommand cmd, RemoteManager remoteManager, PolygonVar traCIVar) {
    cmd.setResponse(responseERR("Not Implemented"));
    return cmd;
  }
  ...
  public TraCICommand processValueSub(TraCICommand rawCmd, RemoteManager remoteManager) {
    return processValueSub(
        ...
        remoteManager,
        this::processGet,
        TraCICmd.GET_POLYGON,
        TraCICmd.RESPONSE_SUB_POLYGON_VALUE);
  }
