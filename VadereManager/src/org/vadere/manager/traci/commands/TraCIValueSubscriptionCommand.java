...
/**
 * Subscription for {@link #variables} of the domain {@link #traCICmd} and {@link
 * #elementIdentifier} {@link #elementIdentifier} '-1' is used for domain global values (i.e.
 * idList) otherwise the {@link #elementIdentifier} is the id of the element (i.e. pedestrian)
 */
