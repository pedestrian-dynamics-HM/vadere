 ...
 * <p>Command Structure
 *
 * <p>[ cmdIdentifier(based on API) ] [ variableId ] [ elementId]
 *
 ...
 * String based id for the object (i.e. a pedestrianId)
 *
...
public class TraCIGetCommand extends TraCICommand {
  ...
  public static TraCIPacket build(
      TraCICmd commandIdentifier, int variableIdentifier, String elementIdentifier) {
