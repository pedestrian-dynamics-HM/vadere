...
public class TraCIGetDistanceCommand extends TraCIGetCommand {
  ...
  public TraCIGetDistanceCommand(
  ...
  public static TraCIGetDistanceCommand create(TraCIGetCommand getCmd) {
    if (getCmd.getTraCICmd().equals(TraCICmd.GET_POLYGON)
      ...
      throw new TraCICommandCreationException(
          "cannot create TraCIGetDistanceCommand from %s", getCmd.toString());
    }
  }
