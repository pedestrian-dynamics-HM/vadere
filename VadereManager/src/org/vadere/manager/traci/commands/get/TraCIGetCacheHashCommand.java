...
public class TraCIGetCacheHashCommand extends TraCIGetCommand {
  ...
  public TraCIGetCacheHashCommand(
      TraCICmd traCICmd, int variableIdentifier, String elementIdentifier) {
  ...
  public static TraCIGetCacheHashCommand create(TraCIGetCommand getCmd) {
    if (getCmd.getTraCICmd().equals(TraCICmd.GET_SIMULATION_VALUE)
      ...
      throw new TraCICommandCreationException(
          "cannot create TraCIGetCacheHashCommand from %s", getCmd.toString());
    }
  }
