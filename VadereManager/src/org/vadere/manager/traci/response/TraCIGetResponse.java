 ...
 *
 * <p>The structure of the response:
 *
 * <p>[ responseID(based on API) ] [ variableId ] [ elementId ] [ dataTypeId ] [ data ]
 *
 * <p>- responseID(based on API): Each API (Person, Vehicle, Simulation, ...) has a different Id. -
 ...
 *
 * <p>See {@link TraCIResponse} for static factory methods used to create objects from byte[]
 */
public class TraCIGetResponse extends TraCIResponse {
  ...
  public boolean equals(Object o) {
    ...
    return responseDataType == that.responseDataType && responseData.equals(that.responseData);
  }
