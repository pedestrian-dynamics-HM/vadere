 ...
 *
 * <p>If no additional data is send the responseIdentifier will be ignored.
 *
 * <p>Construction Methods: (compare with {@link org.vadere.manager.traci.commands.TraCICommand})
 *
 * <p>Each {@link TraCIResponse} class is build in two ways. Either it is created from bytes (i.e.
 * some byte[] wrapped in a {@link ByteBuffer} or {@link TraCICommandBuffer} for ease of use) or
 * manually to prepaid a response to a client.
 */
public class TraCIResponse {
    ...
    switch (commandIdentifier.type) {
      ...
      case VALUE_SET:
        ...
        return createSetResponse(
            commandIdentifier, responseIdentifier, cmdResponseBuffer, statusResponse);
      case VALUE_SUB:
      ...
      default:
        throw new TraCIException(
            "Response Object not implemented for command: " + commandIdentifier.toString());
    }
  }

  // instance methods

  private static TraCIResponse createControlResponse(
      TraCICmd commandIdentifier,
      TraCICommandBuffer cmdResponseBuffer,
  ...
  private static TraCIResponse createSetResponse(
      TraCICmd commandIdentifier,
      TraCICmd responseIdentifier,
      TraCICommandBuffer cmdResponseBuffer,
      StatusResponse statusResponse) {
