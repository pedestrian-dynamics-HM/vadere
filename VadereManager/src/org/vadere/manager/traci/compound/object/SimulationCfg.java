 ...
 *
 * <p>Used to seed Random object and redirect output to a client defined location.
 */
public class SimulationCfg {
  ...
  public static CompoundObject asCompoundObject(
      String configName,
      String experiment,
      String dateTime,
  ...
  public String outputPath() {
    return String.format("%s/%s_%s/vadere.d", resultRootDir, configName, experiment);
  }
