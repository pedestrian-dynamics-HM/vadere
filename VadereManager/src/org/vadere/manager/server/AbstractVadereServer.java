...
public abstract class AbstractVadereServer implements Runnable {
  ...
  public static String SUPPORTED_TRACI_VERSION_STRING =
      "Vadere Simulator. Supports subset of commands based von TraCI Version "
          + SUPPORTED_TRACI_VERSION;
  ...
  public AbstractVadereServer(
      ServerSocket serverSocket, Path baseDir, boolean guiSupport, boolean trace) {
