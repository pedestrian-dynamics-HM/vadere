...
public class CommandHandlerTest {
  ...
  public void checkGET_OK(TraCICommand cmd) {
    ...
    assertThat(
        "Response must be OK",
        getCmd.getResponse().getStatusResponse().getResponse(),
        equalTo(TraCIStatusResponse.OK));
  }

  public void checkGETVersion_OK(TraCICommand cmd) {
    assertThat(
        "command must be a TraCIGetVersionCommand", cmd, instanceOf(TraCIGetVersionCommand.class));
    TraCIGetVersionCommand getVersionCommand = (TraCIGetVersionCommand) cmd;
    assertThat(
        "Response must be OK",
        getVersionCommand.getResponse().getStatusResponse().getResponse(),
        equalTo(TraCIStatusResponse.OK));
  }
  ...
  public void checkGET_Err(TraCICommand cmd) {
    ...
    TraCIGetCommand getCmd = (TraCIGetCommand) cmd;
    assertThat(
        "Response must be Err",
        getCmd.getResponse().getStatusResponse().getResponse(),
        equalTo(TraCIStatusResponse.ERR));
  }
  ...
  public void checkSET_OK(TraCICommand cmd) {
    ...
    assertThat(
        "Response must be OK",
        setCmd.getStatusResponse().getResponse(),
        equalTo(TraCIStatusResponse.OK));
  }
  ...
  public void testGetValue(
      TraCICommand ret, int varID, TraCIDataType varType, String elementID, Object retVal) {
  ...
  public void testSetValue(
      TraCICommand ret, int varID, TraCIDataType varType, String elementID, Object val) {
