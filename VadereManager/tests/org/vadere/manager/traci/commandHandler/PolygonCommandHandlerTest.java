...
public class PolygonCommandHandlerTest extends CommandHandlerTest {
  ...
  public void process_getTopographyBounds() {
    ...
    TraCIGetCommand cmd =
        (TraCIGetCommand)
            getFirstCommand(TraCIGetCommand.build(TraCICmd.GET_POLYGON, varID, elementID));
    RemoteManager rm =
    ...
    RemoteManager rm =
        new TestRemoteManager() {
          ...
          protected void mockIt() {
            ...
            ArrayList<ScenarioElement> scenEls =
                new ArrayList<ScenarioElement>(List.of(scenEl1, scenEl2));
    ...
    RemoteManager rm =
        new TestRemoteManager() {
          ...
          protected void mockIt() {
            ...
            ArrayList<ScenarioElement> scenEls =
                new ArrayList<ScenarioElement>(List.of(scenEl1, scenEl2, scenEl3));
  ...
  public void process_getShape() {
    ...
    List<VPoint> retVal =
        List.of(
            new VPoint(0.0, 0.0), new VPoint(1.0, 0.0), new VPoint(1.0, 1.0), new VPoint(0.0, 1.0));
    TraCIGetCommand cmd =
        (TraCIGetCommand)
            getFirstCommand(TraCIGetCommand.build(TraCICmd.GET_POLYGON, varID, elementID));
    RemoteManager rm =
  ...
  public void process_getDistance() {
    ...
    TraCIGetCommand cmd =
        (TraCIGetCommand)
            getFirstCommand(
                TraCIGetCommand.build(TraCICmd.GET_POLYGON, elementID, varID, varType, point));
    RemoteManager rm =
        new TestRemoteManager() {
          @Override
          protected void mockIt() {
