  ...
  public void createFromBuffer() {
    byte[] data =
        new byte[] {
          ...
          65,
          65,
          (byte) TraCIDataType.INTEGER.id,
          0,
          0,
          0,
          78
        };
    TraCIGetResponse response =
    ...
    assertThat(
        ...
        equalTo(new StatusResponse(TraCICmd.GET_PERSON_VALUE, TraCIStatusResponse.OK, "")));
