...
public class TestPolygon {
  ...
  public void setUp() throws Exception {
    ...
    testTriangle = new VTriangle(new VPoint(30, 50), new VPoint(0, 0), new VPoint(80, 0));
  }

  @Test
  public void testContainsPoint() {
    assertEquals(
        "The polygon should contain this point.", true, testPolygon.contains(new VPoint(10, 10)));
    assertEquals(
        "The polygon should contain this point.", true, testPolygon.contains(new VPoint(0, 10)));
    assertEquals(
        "The polygon should contain this point.", true, testPolygon.contains(new VPoint(0, 0)));
    assertEquals(
  ...
  public void testGetArea() {
    assertEquals(
        "The area of the polygon is wrong.",
  ...
  public void testGetHeight() {
    assertEquals(
        "The height of the polygon is wrong.",
        roomSideLen,
        testPolygon.getBounds2D().getHeight(),
        1e-6);
  }
  ...
  public void testGetWidth() {
    assertEquals(
        "The width of the polygon is wrong.",
        roomSideLen,
        testPolygon.getBounds2D().getWidth(),
        1e-6);
  }
  ...
  public void testClosestPoint() throws IOException {
    ...
    for (int row = 0; row < gridsize; row++) {
      for (int col = 0; col < gridsize; col++) {
        ...
        VPoint currentPoint =
            new VPoint(start + (end - start) * factorX, start + (end - start) * factorY);
    ...
    IOUtils.printDataFile(Paths.get("testreports", "test_polygon2d_closestPoint.txt"), g2string);
  }
