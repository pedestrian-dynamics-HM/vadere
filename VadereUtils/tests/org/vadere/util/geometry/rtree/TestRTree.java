...
public class TestRTree {
  ...
  public void searchLines() {
    ...
    lineRTree
        .search(new VRectangle(-0.1, -0.9, 1, 1).mbr())
        .count()
        .subscribe(c -> assertEquals(2, c.intValue()));
  ...
  public void searchPoints() {
    ...
    pointRTree
        .search(PointDouble.create(0, 0))
        .count()
        .subscribe(c -> assertEquals(1, c.intValue()));
    pointRTree
        .search(new VRectangle(0, 0, 1, 1).mbr())
        .count()
        .subscribe(c -> assertEquals(4, c.intValue()));
    pointRTree
        .search(new VRectangle(0.5, 0, 1, 1).mbr())
        .count()
        .subscribe(c -> assertEquals(2, c.intValue()));
  }
  ...
  public void searchMixed() {
    ...
    rTree
        .search(new VRectangle(1.1, 1.1, 1, 1).mbr())
        .count()
        .subscribe(c -> assertEquals(1, c.intValue()));
