...
public class TestVTriangle {
  ...
  private VTriangle vTriangle_symY_60degree =
      new VTriangle(
          new VPoint(-coor, -radiusShould),
          new VPoint(coor, -radiusShould),
          new VPoint(0., coorTop));
  ...
  private VPoint vPoint4 =
      new VPoint(
          vPoint2.getX() + 0.1,
          vPoint2.getY()); // getter not necessary because attributes are public
  ...
  /**
   * documentation, see: GeometryUtils.java vTriangle_sym.contains is true if the triangle contains
   * the point, otherwise false.
   */
  @Test
  ...
  /**
   * isPartOf( point , 0.0) == vTriangle_sym.contains(point) isPartOf( point , !=0.0) ->
   * vTriangle_sym.contains(point) + tolerance
   */
  @Test
  public void testIsPartOf() {
    // vTriangle_sym.isPartOf returns true if point is a vertex or point is inside triangle +
    // tolerance
  ...
  public void testGetCentroid() {
    ...
    VPoint checkPoint =
        new VPoint(0.0, 1. / 3); // special structure of triangle: midpoint = centroid
  ...
  public void testClosestPoint() {
    ...
    VPoint newPoint2 =
        vTriangle_60degree.closestPoint(vPoint5); // newPoint2 is projection of vPoint1 on y-Axis
    ...
    // 60°-triangle (2 vertices on y-axis), vPoint5 is inside
    VPoint newPoint3 =
        vTriangle_60degree.closestPoint(
            new VPoint(0.0, 0.3)); // newPoint2 is projection of vPoint1 on y-Axis
    x = newPoint3.getX();
    y = newPoint3.getY();
