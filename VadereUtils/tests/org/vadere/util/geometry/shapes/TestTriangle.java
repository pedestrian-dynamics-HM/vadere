...
/** Incomplete tests of the {@link org.vadere.util.geometry.shapes.VTriangle} class. */
public class TestTriangle {
  ...
  public void setUp() throws Exception {
    ...
    testTriangle = new VTriangle(new VPoint(40, 40), new VPoint(30, 50), new VPoint(80, 0));
  }
  ...
  public void testIncenter() {
    ...
    assertTrue(
        "Incenter should be at " + expectedIncenter + " instead it is at " + incenter,
        expectedIncenter.equals(incenter, tolerance));
  ...
  public void testOrthocenter() {
    ...
    assertTrue(
        "Orthocenter should be at " + expectedOrthocenter + " instead it is at " + orthcenter,
        expectedOrthocenter.equals(orthcenter, tolerance));
  }
