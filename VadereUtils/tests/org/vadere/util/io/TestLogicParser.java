...
public class TestLogicParser {
  ...
  public void testSubSet() throws ParseException {
    ...
    assertTrue(
        "shape.x:{0.5,0.7,0.1}",
        new JsonLogicParser("shape.x:{0.5,0.7,0.1}").parse().test(jsonObject));
    assertTrue(
        "targetIds:{2,3,4,5.3}",
        new JsonLogicParser("targetIds:{2,3,4,5.3}").parse().test(jsonObject));
    assertTrue(
        "targetIds:{1,2,3,4,5}",
        new JsonLogicParser("targetIds:{1,2,3,4,5}").parse().test(jsonObject));
    assertTrue(
        "targetIds:{1,2.0,3,4,5}",
        new JsonLogicParser("targetIds:{1,2.0,3,4,5}").parse().test(jsonObject));

    assertFalse("id:{1,2,3}", new JsonLogicParser("id:{1,2,3}").parse().test(jsonObject));
    assertFalse(
        "shape.x:{0.55,0.7,0.1}",
        new JsonLogicParser("shape.x:{0.55,0.7,0.1}").parse().test(jsonObject));
    assertFalse(
        "targetIds:{2,3,5,6}", new JsonLogicParser("targetIds:{2,3,5,6}").parse().test(jsonObject));
  ...
  public void testSuperSet() throws ParseException {
    ...
    assertTrue(
        "{2,3,4}:targetIds", new JsonLogicParser("{2,3,4}:targetIds").parse().test(jsonObject));
    assertTrue(
        "{2,3.0,4}:targetIds", new JsonLogicParser("{2,3.0,4}:targetIds").parse().test(jsonObject));
    assertTrue(
        "{3.0,4}:targetIds", new JsonLogicParser("{3.0,4}:targetIds").parse().test(jsonObject));
    ...
    assertFalse(
        "{3.0,4,2,5.0}:targetIds",
        new JsonLogicParser("{3.0,4,2,5.0}:targetIds").parse().test(jsonObject));
  }
  ...
  public void testEquals() throws ParseException {
    ...
    assertFalse(
        "shape.type==POLYGON", new JsonLogicParser("shape.type==POLYGON").parse().test(jsonObject));
  }
  ...
  public void testNot() throws ParseException {
    ...
    assertTrue(
        "!(shape.type==POLYGON)",
        new JsonLogicParser("!(shape.type==POLYGON)").parse().test(jsonObject));
  }
  ...
  public void testComplexExpression() throws ParseException {
    ...
    assertTrue(
        "(id<=6 && id>4 && id<7 && spawnDelay==2.0) && {6}:id",
        new JsonLogicParser("(id<=6 && id>4 && id<7 && spawnDelay==2.0) && {6}:id")
            .parse()
            .test(jsonObject));
    assertTrue(
        "(id<=6 || id>8 && id<7 || spawnDelay==7.0) && {6}:id",
        new JsonLogicParser("(id<=6 || id>8 && id<7 || spawnDelay==7.0) && {6}:id")
            .parse()
            .test(jsonObject));
    ...
    assertFalse(
        "(id<=6 && id>4 && id<7 && spawnDelay==2.0) && {6,7}:id",
        new JsonLogicParser("(id<=6 && id>4 && id<7 && spawnDelay==2.0) && {6,7}:id")
            .parse()
            .test(jsonObject));
    assertFalse(
        "(id<=5 || id>8 && id<7 || spawnDelay==7.0) && {6}:id",
        new JsonLogicParser("(id<=5 || id>8 && id<7 || spawnDelay==7.0) && {6}:id")
            .parse()
            .test(jsonObject));
