...
/**
 * For example, this class can be used for creating {@link attributes.Attributes} or {@link
 * models.Model}s.
 *
...
public class DynamicClassInstantiator<T> {
  ...
  public T createObject(Class<? extends T> clazz) throws CouldNotInstantiateException {
