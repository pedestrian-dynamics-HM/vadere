...
/**
 * Extended Logger interface with convenience methods for the DIAG, NOTICE and VERBOSE custom log
 * levels.
 *
...
public final class Logger extends ExtendedLoggerWrapper {
  ...
  public static Logger getLogger(final Class<?> loggerName, final MessageFactory messageFactory) {
    final org.apache.logging.log4j.Logger wrapped =
        LogManager.getLogger(loggerName, messageFactory);
    return new Logger(wrapped);
  }
  ...
  /**
   * Logs a message at the {@code STDERR} level including the stack trace of the {@link Throwable}
  ...
  /**
   * Logs a CharSequence at the {@code STDERR} level including the stack trace of the {@link
   ...
   *     depends on the message factory.
   * @since Log4j-2.4
   */
  ...
  /**
   * Logs a message (only to be constructed if the logging level is the {@code STDERR} level)
   * including the stack trace of the {@link Throwable} <code>t</code> passed as parameter.
   *
   * @param msgSupplier A function, which when called, produces the desired log message; the format
   *     depends on the message factory.
   * @param t the exception to log, including its stack trace.
  ...
  /**
   * Logs a message (only to be constructed if the logging level is the {@code STDERR} level) with
   * the specified Marker and including the stack trace of the {@link Throwable} <code>t</code>
   * passed as parameter.
   *
   * @param marker the marker data specific to this log statement
   * @param msgSupplier A function, which when called, produces the desired log message; the format
  ...
  /**
   * Logs a message which is only to be constructed if the logging level is the {@code STDERR} level
   * with the specified Marker. The {@code MessageSupplier} may or may not use the {@link
   ...
   * Logs a message (only to be constructed if the logging level is the {@code STDERR} level) with
   * the specified Marker and including the stack trace of the {@link Throwable} <code>t</code>
   * passed as parameter. The {@code MessageSupplier} may or may not use the {@link MessageFactory}
   * to construct the {@code Message}.
   *
   * @param marker the marker data specific to this log statement
   * @param msgSupplier A function, which when called, produces the desired log message.
   * @param t A Throwable or null.
  ...
  /**
   * Logs a message which is only to be constructed if the logging level is the {@code STDERR}
   * level. The {@code MessageSupplier} may or may not use the {@link MessageFactory} to construct
   * the {@code Message}.
   *
   * @param msgSupplier A function, which when called, produces the desired log message.
   * @since Log4j-2.4
  ...
  /**
   * Logs a message (only to be constructed if the logging level is the {@code STDERR} level)
   * including the stack trace of the {@link Throwable} <code>t</code> passed as parameter. The
   * {@code MessageSupplier} may or may not use the {@link MessageFactory} to construct the {@code
   * Message}.
   *
   * @param msgSupplier A function, which when called, produces the desired log message.
   * @param t the exception to log, including its stack trace.
  ...
  /**
   * Logs a message at the {@code STDOUT} level including the stack trace of the {@link Throwable}
   * {@code t} passed as parameter.
   *
   * @param marker the marker data specific to this log statement
   * @param message the message to log.
  ...
  /**
   * Logs a CharSequence at the {@code STDOUT} level including the stack trace of the {@link
   * Throwable} {@code t} passed as parameter.
   *
   * @param message the CharSequence to log.
   * @param t the exception to log, including its stack trace.
  ...
  /**
   * Logs a message (only to be constructed if the logging level is the {@code STDOUT} level)
   * including the stack trace of the {@link Throwable} <code>t</code> passed as parameter.
   *
   * @param msgSupplier A function, which when called, produces the desired log message; the format
   *     depends on the message factory.
  ...
  /**
   * Logs a message (only to be constructed if the logging level is the {@code STDOUT} level) with
   * the specified Marker and including the stack trace of the {@link Throwable} <code>t</code>
   * passed as parameter.
   *
   * @param marker the marker data specific to this log statement
  ...
  /**
   * Logs a message which is only to be constructed if the logging level is the {@code STDOUT}
   * level. The {@code MessageSupplier} may or may not use the {@link MessageFactory} to construct
   * the {@code Message}.
   *
   * @param msgSupplier A function, which when called, produces the desired log message.
