...
/**
 * Manage all {@link java.util.ResourceBundle}s present in the application. Each module must use
 * this Manager to allow easy inheritance of language keys. If the application language is changed
 * this manager will propagate the new Locale to each Bundel.
 */
