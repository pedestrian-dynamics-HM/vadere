...
public abstract class AParallelWorker<ResultType> {
  /**
   * Internal class representing the work the {@link AParallelWorker} should do. Implementation is
   * done by the classes that use the {@link AParallelWorker}.
   */
  ...
  /**
   * Finishes the given parallel operation and returns the result. This pauses the calling thread.
   *
   * @return
   * @throws InterruptedException
   * @throws ExecutionException
   */
  public abstract ResultType finish() throws InterruptedException, ExecutionException;
}
