...
public class Vector2D extends VPoint {
  ...
  /**
   * Computes the angle3D between the x-axis through the given Point (0,0) and this. Result is in
  ...
  /**
   * Computes the angle3D between the x-axis through the given Point center and this. Result is in
   * interval (0,2*PI) according to standard math usage.
   *
