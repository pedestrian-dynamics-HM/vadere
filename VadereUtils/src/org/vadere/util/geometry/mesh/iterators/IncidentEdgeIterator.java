 ...
 */
public class IncidentEdgeIterator<P extends IPoint, E extends IHalfEdge<P>, F extends IFace<P>> implements Iterator<E> {
	...
	public IncidentEdgeIterator(final IMesh<P, E, F> mesh, final E edge) {
		this.mesh = mesh;
		this.edge = edge;
