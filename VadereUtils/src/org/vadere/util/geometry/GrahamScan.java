...
public class GrahamScan {
  ...
  public static class VPointPolarComparator implements Comparator<VPoint> {
    ...
    /**
     * Compare o1 and o2 relative with respect to a circle around point (*), starting from rad=0 to
     * rad=2pi (counter clock wise). _______ | | | * | |_____|
     *
     * @param o1 first point
     * @param o2 second point
     * @return -1 if o1 will be scanned before o2, 1 if o1 will be scanned after o2, 0 otherwise.
     */
    @Override
