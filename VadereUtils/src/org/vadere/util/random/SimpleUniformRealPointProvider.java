...
public class SimpleUniformRealPointProvider implements IPointProvider {
  ...
  public SimpleUniformRealPointProvider(
      final Random random, double xUpperBound, double yUpperBound) {
  ...
  public SimpleUniformRealPointProvider(
    ...
    xDist =
        new UniformRealDistribution(
            new JDKRandomGenerator(random.nextInt()), xLowerBound, xUpperBound);
    yDist =
        new UniformRealDistribution(
            new JDKRandomGenerator(random.nextInt()), yLowerBound, yUpperBound);
  }
