...
public class SimpleReachablePointProvider implements IReachablePointProvider {
  ...
  public static SimpleReachablePointProvider constant(
      double resolution, Rectangle2D.Double bound, IDistanceFunction distanceFunction) {
    IPointProvider constant =
        new ConstantIntegerPointProvider(
  ...
  public static SimpleReachablePointProvider uniform(
      final Random random, Rectangle2D.Double bound, IDistanceFunction distanceFunction) {
    IPointProvider uniform =
        new SimpleUniformRealPointProvider(
            random, bound.x, bound.x + bound.width, bound.y, bound.y + bound.height);
