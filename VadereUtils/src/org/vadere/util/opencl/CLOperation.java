...
/**
 * This class implements operation to set up and to destroy an OpenCL context which every OpenCL
 * class requires.
 */
public abstract class CLOperation {
  ...
  /**
   * Returns a long number n which is greater or equals <tt>value</tt> such that n = k *
   * <tt>multiple</tt> for some natural number k.
   *
