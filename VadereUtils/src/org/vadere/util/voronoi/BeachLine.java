...
public class BeachLine {
  ...
  BeachLineLeaf addSite(
      int id, VPoint site, BeachLineLeaf arc, List<Face> faces, boolean siteOnHorizontalLine) {
    ...
    if (!siteOnHorizontalLine) {
      ...
      BeachLineLeaf leftLeaf = new BeachLineLeaf(arc.getSite(), arc.getFace());
      BeachLineLeaf rightLeaf = new BeachLineLeaf(arc.getSite(), arc.getFace());
      centerLeaf = new BeachLineLeaf(site, new Face(id, site, faces, limits));
      ...
      BeachLineInternal lowerNode =
          new BeachLineInternal(centerLeaf, rightLeaf, site, arc.getSite());
      upperNode = new BeachLineInternal(leftLeaf, lowerNode, arc.getSite(), site);
      ...
      upperNode = new BeachLineInternal(leftLeaf, centerLeaf, arc.getSite(), site);
