...
public class RectangleLimits {
  ...
  public RectangleLimits(double xLimitLow, double yLimitLow, double xLimitHigh, double yLimitHigh) {
  ...
  public boolean isInside(VPoint site) {
    ...
    if (position.x < xLow || position.x > xHigh || position.y < yLow || position.y > yHigh) {
      result = false;
    }
