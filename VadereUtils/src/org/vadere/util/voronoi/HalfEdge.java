...
/**
 * Double-Connected Edge List according to the data structure described in the book Computational
 * Geometry by Mark de Berg et al. (2008) pages 29ff.
 */
public class HalfEdge {
  ...
  static void handleSiteEventEdges(
      List<Face> faces,
      BeachLineLeaf newLeaf,
      BeachLineLeaf arcAboveLeaf,
      boolean siteOnHorizontalLine) {
  ...
  static HalfEdge handleCircleEventEdges(
      BeachLineInternal leftNode, BeachLineInternal rightNode, VPoint vertex) {
