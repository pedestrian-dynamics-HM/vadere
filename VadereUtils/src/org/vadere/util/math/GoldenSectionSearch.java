...
public class GoldenSectionSearch {
  ...
  /**
   * Computes a subinterval [a1;b1] of [a;b] such that the minimum of f is contained in [a1;b1]. The
   * tolerance <tt>tol</tt> controls the accuracy, that is the size of the subinterval. This method
   * uses recursion.
   *
   ...
   */
  public static double[] gss(
      @NotNull final Function<Double, Double> f, final double a, final double b, final double tol) {
    return gss(f, a, b, tol, b - a, true, 0, 0, true, 0, 0);
  }

  private static double[] gss(
