...
/**
 * Implementation of the 1-dimensional Nelder-Mead. The algorithm walks on the circle. Multiple
 * simplexes can be solved in parallel (default).
 *
    ...
    this.simplices =
        simplexes
            ...
            .map(
                s ->
                    new Simplex1D(
                        eval, s.getLeft(), s.getRight(), evalArea, minimize, NelderMead2D.MAX_VAL))
