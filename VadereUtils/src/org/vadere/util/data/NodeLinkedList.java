...
/**
 * A implementation of a Linked List that supports accessible pointers (i.e. Node) to the elements
 * of the Linked List.
 *
...
public class NodeLinkedList<E> implements Iterable<Node<E>> {
  ...
  /**
   * Suspend all elements to the beginning of the Linked List, i.e. assume the headList = [A,B,C]
   * and this = [E,F,D] the result is [A,B,C,E,F,D].
   *
  ...
  /**
   * Inserts an element next to the anchor. Note the anchor has to be part of this list, otherwise
   * the resulting Linked List becomes invalid.
   *
   * @param element the element to that will be inserted
   * @param anchor the pointer that points to the position at which the element will inserted (to
   *     the right)
  ...
  /**
   * Inserts an element before the anchor. Note the anchor has to be part of this list, otherwise
   * the resulting Linked List becomes invalid.
   *
   * @param element the element to that will be inserted
   * @param anchor the pointer that points to the position at which the element will inserted (to
  ...
  /**
   * Splits the Linked List into two lists. The split takes part at the first element that satisfy
   * the predicate. This element will be part of the first list. The first list will be returned and
   * this list will be the remaining part.
   *
  ...
  /**
   * Returns a list containing all elements satisfying the predicate. The list may contain
   * duplicated entries.
   *
   * @param predicate the predicate condition
  ...
  /**
   * Computes the prefix length of elements satisfying the predicate condition and removes this
   * prefix from the Linked List.
   *
   * @param predicate the predicate condition
   * @param counter the function that defines the counting of elements
   * @return the length of the prefix defined by the Function counter
  ...
  /**
   * Computes the suffix length of elements satisfying the predicate condition and removes this
   * suffix from the Linked List.
   *
   * @param predicate the predicate condition
   * @param counter the function that defines the counting of elements
   * @return the length of the suffix defined by the Function counter
  ...
  /**
   * Computes and returns the size of the linked list. Complexity: O(|n|), where n is the numbers of
  ...
  /**
   * Returns an Iterator of pointers that iterates pointers in descending order, i.e. from right to
   * left.
   *
  ...
  /**
   * Returns an Iterator of pointers that iterates pointers in ascending order, i.e. from left to
   * right.
   *
  ...
  /**
   * Returns an Iterable of pointers that iterates pointers in ascending order, i.e. from left to
   * right.
   *
  ...
  private long removePrefix(
      final Predicate<E> predicate,
      final Iterator<Node<E>> iterator,
      final Function<E, Long> counter) {
  ...
  private long prefix(
      ...
      final Iterator<Node<E>> iterator,
      final Function<E, Long> counter,
      final Consumer<Iterator> consumer) {
    long count = 0;
    while (iterator.hasNext()) {
      Node<E> node = iterator.next();
      if (predicate.test(node.getElement())) {
