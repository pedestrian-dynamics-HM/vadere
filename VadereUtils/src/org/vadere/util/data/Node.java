...
public class Node<E> {
  ...
  /**
   * Inserts a whole MyLinkedList of elements before the node i.e. assume elements = [A,B,C] and the
   * Linked list of the node = [D,E,F] and the node = E the result will be [D,A,B,C,E,F].
   *
  ...
  /**
   * Inserts a whole MyLinkedList of elements after the node i.e. assume elements = [A,B,C] and the
   * Linked list of the node = [D,E,F] and the node = E the result will be [D,E,A,B,C,F].
   *
   * @param elements the list that will be suspend to this list.
   */
  ...
  public boolean equals(Object obj) {
    if (obj == null) {
      ...
      Node node = (Node) obj;
      return this.getElement() == null && node.getElement() == null
          || (this.getElement() != null && this.getElement().equals(node.getElement()));
    }
  }
}
