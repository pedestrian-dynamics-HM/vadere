...
/**
 * Overwrite the standard {@link org.vadere.util.factory.FactoryObject} to save the additional
 * mapping information between DataKey and OutputFileType
 *
 * @param <T>
 */
public class OutputFileBaseFactory<T> extends BaseFactory<T, OutputFileFactoryObject<T>> {
  ...
  public void addMember(Class clazz, Supplier supplier, String label, String desc, String keyName) {
    supplierMap.put(
        ...
        new OutputFileFactoryObject<T>(clazz, supplier, label, desc, keyName));
  }
