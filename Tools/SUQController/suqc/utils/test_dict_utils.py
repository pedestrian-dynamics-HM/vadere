...
class DictUtilTests(unittest.TestCase):
    ...
    def test_subjsons(self):
        ...
        self.assertEqual(deep_dict_lookup(d, "a.[b==1].c", False, False), (1, ["a", "[b==1]", "c"]))
        # changing the condition:
        self.assertEqual(deep_dict_lookup(d, "a.[c==1].b", False, False), (1, ["a", "[c==1]", "b"]))

        self.assertEqual(deep_dict_lookup(d, "a.[c==1].c", False, False), (1, ["a", "[c==1]", "c"]))
        ...
        d2 = {"a": [{"b": 1, "c": 1}, {"b": 1, "c": 2}]}  # list increased by one element
        self.assertEqual(deep_dict_lookup(d2, "a.[c==2].b", False, False), (1, ["a", "[c==2]", "b"]))
        self.assertEqual(deep_dict_lookup(d2, ".a.[c==2].b", False, False), (1, ["a", "[c==2]", "b"]))
        self.assertEqual(deep_dict_lookup(d2, "a.[c==2].c", False, False), (2, ["a", "[c==2]", "c"]))

        with self.assertRaises(KeyError):
            self.assertEqual(deep_dict_lookup(d2, "a.[b==1].b", False, False), (1, ["a", "[c==2]", "b"]))

        d3 = {"a": {"z": [{"b": 1, "c": 1}, {"b": 1, "c": 2}]}, "y": 99, "yy": [{"i": 1}]}
        self.assertEqual(deep_dict_lookup(d3, "z.[c==1].c", False, False), (1, ["a", "z", "[c==1]", "c"]))
