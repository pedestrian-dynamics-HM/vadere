...
public class ReferenceCoordinateSystemTest {
  ...
  public void convertToGeo1() {
    ReferenceCoordinateSystem c =
        new ReferenceCoordinateSystem("EPSG:25832", "", new VPoint(0.0, 0.0));
  ...
  public void convertToGeo() {
    ReferenceCoordinateSystem c =
        new ReferenceCoordinateSystem("EPSG:32632", "", new VPoint(692000.0, 5337000.0));
