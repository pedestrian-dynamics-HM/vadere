...
public class TestStairs {
  ...
  public void setUp() throws Exception {
    ...
    attributes1 =
        StateJsonConverter.deserializeObjectFromJson(attributesStore1, AttributesStairs.class);
    ...
    attributes2 =
        StateJsonConverter.deserializeObjectFromJson(attributesStore2, AttributesStairs.class);
