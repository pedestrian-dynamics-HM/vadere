...
public class DistributionStub extends VDistribution {
  ...
  public DistributionStub(AttributesDistribution parameter, RandomGenerator randomGenerator)
      throws Exception {
    super(parameter, randomGenerator);
  }

  @Override
  protected void setValues(AttributesDistribution parameter, RandomGenerator randomGenerator)
      throws Exception {}
