...
public class StateJsonConverterTest {
  ...
  public void deserializeEventsFromArrayNodeReturnsEventInfoStoreIfPassingValidArrayNode() {
    ...
    StimulusInfoStore actualStimulusInfoStore =
        StateJsonConverter.deserializeStimuliFromArrayNode(jsonNode);
    ...
    assertEquals(
        expectedStimulusInfo.getTimeframe().getStartTime(),
        actualStimulusInfo.getTimeframe().getStartTime(),
        allowedDelta);
    assertEquals(
        expectedStimulusInfo.getTimeframe().getEndTime(),
        actualStimulusInfo.getTimeframe().getEndTime(),
        allowedDelta);
    assertEquals(
        expectedStimulusInfo.getTimeframe().isRepeat(),
        actualStimulusInfo.getTimeframe().isRepeat());
    assertEquals(
        expectedStimulusInfo.getTimeframe().getWaitTimeBetweenRepetition(),
        actualStimulusInfo.getTimeframe().getWaitTimeBetweenRepetition(),
        allowedDelta);
  }
