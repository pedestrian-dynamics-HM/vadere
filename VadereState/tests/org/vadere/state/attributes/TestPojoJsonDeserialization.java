...
public class TestPojoJsonDeserialization {
  ...
  public void testEmptyDeserializationWithImplicitDefaultCtor() throws IOException {
    ...
    assertTestPojoEquals(
        new TestPojoWithImplicitDefaultConstructor(),
        "{}",
        TestPojoWithImplicitDefaultConstructor.class);
  }
  ...
  public void testIncompleteDeserialization() throws IOException {
    ...
    // the init values (for a and b) in POJOs take effect!
    assertTestPojoEquals(
        new TestPojoWithDefaultConstructor(1, 5),
        incompleteJson,
        TestPojoWithDefaultConstructor.class);
  }

  @Test
  public void testCompleteDeserialization() throws IOException {
    assertTestPojoEquals(
        new TestPojoWithDefaultConstructor(4, 5),
        completeJson,
        TestPojoWithDefaultConstructor.class);
  }
  ...
  public void testIncompleteDeserializationWithoutDefaultCtor() {
    try {
      assertTestPojoEquals(
          new TestPojoWithoutDefaultConstructor(0, 5),
          incompleteJson,
          TestPojoWithoutDefaultConstructor.class);
    } catch (IOException e) {
      // Test successful
    }
  }
