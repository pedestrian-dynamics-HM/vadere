...
public class CompoundObjectBuilder {
  ...
  public static CompoundObjectBuilder builder() {
    return new CompoundObjectBuilder();
  }

  public static CompoundObject json(String json) {

    return CompoundObjectBuilder.builder().rest().add(TraCIDataType.STRING).build(json);
  }
  ...
  public CompoundObject build(Object... data) {
    ...
    if (types.size() == data.length) {
      ...
      throw new TraCIException(
          "CompoundObjectBuilder error. Number of Types does not match"
