...
public class PsychologyStatus {
  ...
  public void setNextPerceivedStimuli(final LinkedList<Stimulus> nextPerceivedStimuli) {
    this.nextPerceivedStimuli = nextPerceivedStimuli;
  }
}
