 ...
 *
 * <p>This stimulus holds one additional information: a target id which represents the origin of the
 * threat.
 */
public class Threat extends Stimulus {
  ...
  // Getter
  public int getOriginAsTargetId() {
    return originAsTargetId;
  }
  ...
  // Setter
  public void setOriginAsTargetId(int originAsTargetId) {
    this.originAsTargetId = originAsTargetId;
  }
