 ...
 *
 * <p>This information is required by a stimulus controller which injects the actual stimuli into
 * the simulation loop.
 */
public class Timeframe {
  ...
  public Timeframe(
      double startTime, double endTime, boolean repeat, double waitTimeBetweenRepetition) {
