...
/**
 * Class encodes some kind of information a pedestrian knows about. The information is active from
 * the time gien in {@link #time} and will be forgotten at {@link #obsoleteAt} (or never if {@link
 * #obsoleteAt} == -1
 */
