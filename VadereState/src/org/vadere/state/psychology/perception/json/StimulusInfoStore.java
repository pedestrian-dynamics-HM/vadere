 ...
 *
 * <p>This class is just a wrapper to get a convenient JSON de-/serialization. The JSON
 * serialization should look like this:
 *
 * <p>"stimulusInfos": [ { "timeframe": { "startTime":..., "endTime":..., "repeat":...,
 * "waitTimeBetweenRepetition":... }, "stimuli": [ {"type":"ElapsedTime" }, {"type":"WaitInArea",
 * "area": ... }, ... ] }, { ... } ]
 */
public class StimulusInfoStore {
  ...
  public static void main(String... args) {
    ...
    try {
      ...
      StimulusInfoStore deserializedStimulusInfoStore =
          mapper.readValue(jsonDataString, StimulusInfoStore.class);
    ...
    try {
      ...
      String changeTargetEventAsJsonString =
          mapper.writeValueAsString(new ChangeTarget(0.0, newTargetIds));
