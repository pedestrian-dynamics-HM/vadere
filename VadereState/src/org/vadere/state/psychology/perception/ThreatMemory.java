 ...
 *
 * <ol>
 *   <li>Cognition layer detects a {@link Threat}.
 *   <li>In locomotion layer, a {@link Pedestrian} has no time credit to react to the {@link
 *       Threat}.
 *   <li>In next simulation loop, the {@link Threat} is already gone. I.e., the {@link Threat} from
 *       previous simulation loop would be lost.
 * </ol>
 *
 * Therefore, provide a {@link ThreatMemory} with a boolean flag included which indicates if latest
 * {@link Threat} was already handled by the locomotion layer.
 *
 * <p>Note: Maybe, this memory could also be implemented as a stack. I.e., cognition layer pushes
 * {@link Threat}s to the stack while the locomotion layer pops off the {@link Threat}s. But, this
 * is ot a real "memory"!
 */
public class ThreatMemory {
  ...
  public boolean isLatestThreatUnhandled() {
    return latestThreatUnhandled;
  }
