...
public class UnsupportedSelfCategoryException extends RuntimeException {
  ...
  public UnsupportedSelfCategoryException(
      @NotNull SelfCategory unsupportedSelfCategory, @NotNull Class implementingClass) {
    super(
        String.format(
            "SelfCategory \"%s\" is not supported by class \"%s\"!",
            unsupportedSelfCategory, implementingClass.getSimpleName()));
  }

  public static void throwIfPedestriansNotTargetOrientied(
      Collection<? extends Pedestrian> pedestrians, Class caller) {
