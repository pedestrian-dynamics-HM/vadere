...
public enum GradientProviderType {
  ...
  /**
   * using continuous solution with Euklidean distance to targets, mollified so that the gradient is
   * continuous
   */
  OBSTACLE_CONTINUOUS,
  ...
  /**
   * uses PEDESTRIAN_CONTINUOUS, but enables the user to define two teleporter lines where the
   * pedestrians are set back to the respective other line.
   */
