...
public class AttributesLogEventProcessor extends AttributesProcessor {
  ...
  /**
   * The compartment to observe. Index 0 and the last index denote half-compartments which should
   * not be observed.
   */
  ...
  /**
   * Offset to add to the pedestrian ID in order to prevent duplicate person IDs from different log
   * event processors.
   */
  private int personIdOffset = 0;
  /**
   * Log event ID for initializing the ID counter to prevent duplicate log event IDs from different
