...
public class AttributesPotentialSFM extends Attributes {
	...
	private final double pedestrianBodyPotential = 2.1; // V_{\alpha \beta}^0, default from helbing-1995
	private final double pedestrianRecognitionDistance = 0.3; // sigma, default from helbing-1995

	private final double obstacleBodyPotential = 10.0; // U_{\alpha B}^0, default from helbing-1995
	private final double obstacleRepulsionStrength = 0.2; // R, default from helbing-1995
