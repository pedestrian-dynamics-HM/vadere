...
/**
 * This class contains a default parameter setting for emulating the cellular automaton with the
 * Optimal Steps Model
 *
 * @author hm-mgoedel
 */
...
public class AttributesCA extends AttributesOSM {
  ...
  /**
   * Von-Neumann neighbourhood is realized with stepCircleResolution = 4 and numberOfCircles = 1 One
   * advantage of von-Neumann neighbourhood compared to Moore neighbourhood is that the step size to
   * the next cell is the same for all neighbors with von-Neumann neighbourhood.
   */
  ...
  private String pedestrianPotentialModel =
      "org.vadere.simulator.models.potential.PotentialFieldPedestrianCA";
  private String obstaclePotentialModel =
      "org.vadere.simulator.models.potential.PotentialFieldObstacleCA";
