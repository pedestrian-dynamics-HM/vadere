 ...
 * IntegratorType, minStepSize, maxStepSize, absoluteTolerance, relativeTolerance. For methods
 * without step size control, minStepSize and maxStepSize should be equal.
 */
@ModelAttributeClass
