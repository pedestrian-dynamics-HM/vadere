...
/**
 * AttributesAirTransmissionModel contains user-defined properties related to the <code>
 * AirTransmissionModel</code>. They define properties that are shared by all instances of
 *
 * <ul>
 *   <li><code>Pedestrian</code>
 *   <li><code>AerosolCloud</code>
 *   <li><code>Droplets</code>
 * </ul>
 */
@ModelAttributeClass
public class AttributesAirTransmissionModel extends AttributesExposureModel {

  /** Equals 1/(pedestrians' average breathing rate). Unit: seconds */
