...
public class AttributesAirTransmissionModelDroplets extends Attributes {
  ...
  /**
   * Describes how often {@link Droplets} are emitted by an infectious pedestrian. Unit: 1 / second
   */
  private double emissionFrequency;

  /**
   * Describes the shape of {@link AttributesDroplets}: Radius of the circular segment. Unit: meter
   */
  private double distanceOfSpread;

  /**
   * Describes the shape of {@link AttributesDroplets}: Angle of the circular segment. Unit: degree
   */
  private double angleOfSpreadInDeg;

  /** Describes the persistence of {@link Droplets}. Unit: second */
  private double lifeTime;

  /**
   * Describes the pathogen load within {@link Droplets}. It remains constant over {@link
   * #lifeTime}. Unit: particles
   */
  private double pathogenLoad;

  /**
   * Describes the fraction infectious particles inhaled from droplets if the inhaling agent is
   * located within droplets. Unit: 1 / inhalation
   */
  ...
  public AttributesAirTransmissionModelDroplets(
      ...
      double distanceOfSpread,
      double angleOfSpreadInDeg,
      double lifeTime,
      double pathogenLoad,
