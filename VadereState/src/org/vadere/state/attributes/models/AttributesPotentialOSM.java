...
public class AttributesPotentialOSM extends Attributes {
	...
	// seitz-2012 u_p = 1000
	private final double pedestrianBodyPotential = 1000;

	// seitz-2012 h_p = 1.0
	private final double pedestrianRepulsionWidth = 1.0;

	// seitz-2012 v_p = 0.4
	private final double pedestrianRepulsionStrength = 0.4;

	// seitz-2012 a_p = 1.0
	private final double aPedOSM = 3.5;

	// seitz-2012 b_p = 0.2
	private final double bPedOSM = 0.6;

	//
	private final double pedestrianRecognitionDistance = 1.5;

	//
	private final double personalDensityFactor = 1.2;

	// seitz-2012 u_o = 10000
	private final double obstacleBodyPotential = 10000;

	// seitz-2012 h_o = 6.0
	private final double obstacleRepulsionWidth = 6;

	// seitz-2012 v_o = 0.2
	private final double obstacleRepulsionStrength = 0.2;

	// seitz-2012 a_o = 3.0
	private final double aObsOSM = 3.5;

	// seitz-2012 b_0 = 2.0
	private final double bObsOSM = 0.2;
