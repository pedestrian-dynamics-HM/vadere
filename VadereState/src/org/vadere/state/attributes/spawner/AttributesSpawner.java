...
@JsonSubTypes({
  @JsonSubTypes.Type(
    value = AttributesRegularSpawner.class,
    name = "org.vadere.state.attributes.spawner.AttributesRegularSpawner"
  ),
  @JsonSubTypes.Type(
    value = AttributesLerpSpawner.class,
    name = "org.vadere.state.attributes.spawner.AttributesLerpSpawner"
  ),
  @JsonSubTypes.Type(
    value = AttributesMixedSpawner.class,
    name = "org.vadere.state.attributes.spawner.AttributesMixedSpawner"
  ),
  @JsonSubTypes.Type(
    value = AttributesTimeSeriesSpawner.class,
    name = "org.vadere.state.attributes.spawner.AttributesTimeSeriesSpawner"
  )
})
public abstract class AttributesSpawner extends Attributes {
  ...
  public static final String CONSTANT_DISTRIBUTION =
      "org.vadere.state.scenario.distribution.impl.ConstantDistribution";
  /**
   * This attribute stores the maximum number of agents that can be spawned by this spawner. No
   * limit, if set to -1.
   */
  ...
  /**
   * This attribute stores the ending time of a spawner after which no agents can be spawned
   * anymore.
   */
  @VadereAttribute(group = "Time Constraints")
  @JsonView(Views.CacheViewExclude.class)
   ...
   */
  @VadereAttribute protected Integer eventElementCount = 1;
