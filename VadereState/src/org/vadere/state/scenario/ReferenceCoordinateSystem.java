...
public class ReferenceCoordinateSystem {
  ...
  /**
   * international identifier for the base coordinate reference system (CRS) which was used to build
   * this topography. e.g.
   *
   * <p>EPSG:4326 = WGS-84 (lon/lat from GPS systems, used in OpenStreetMap) EPSG:25832 = ETRS89 /
   * UTM Zone 32N (UTM Zone System) zone 32 contains most of germany.
   *
   * <p>see https://de.wikipedia.org/wiki/European_Petroleum_Survey_Group_Geodesy#EPSG-Codes
   * https://de.wikipedia.org/wiki/UTM-Koordinatensystem#Aufbau for references
   */
  private String epsgCode = "";
  /** short description of epsgCode. e.g. "WGS-84 OpenStreetMap (OSM)" for none GIS nerds ;) */
  private String description = "";

  private transient CoordinateReferenceSystem geoCRS;
  private transient CoordinateReferenceSystem utmCRS;
  private transient CoordinateOperation geoToUtm;
  private transient CoordinateOperation utmToGeo;
