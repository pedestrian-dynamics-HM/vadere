...
public abstract class ScenarioElement<T extends AttributesScenarioElement>
  ...
  /**
   * Redeclare the clone method as public to enable copy & paste of scenario elements in scenario
   * editor. Subclasses must implement this method using a copy constructor.
   */
  @Override
