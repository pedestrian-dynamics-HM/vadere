...
@JsonSubTypes({
  @JsonSubTypes.Type(
    value = RegularSpawner.class,
    name = "org.vadere.state.scenario.spawner.impl.RegularSpawner"
  ),
  @JsonSubTypes.Type(
    value = LERPSpawner.class,
    name = "org.vadere.state.scenario.spawner.impl.LERPSpawner"
  ),
  @JsonSubTypes.Type(
    value = TimeSeriesSpawner.class,
    name = "org.vadere.state.scenario.spawner.impl.TimeSeriesSpawner"
  ),
  @JsonSubTypes.Type(
    value = MixedSpawner.class,
    name = "org.vadere.state.scenario.spawner.impl.MixedSpawner"
  )
})
    ...
    try {
      this.distribution =
          DistributionFactory.create(
              attributes.getDistributionAttributes(), new JDKRandomGenerator(random.nextInt()));
    } catch (Exception e) {
