...
public class PoissonDistribution extends VDistribution<AttributesPoissonDistribution> {
  ...
  public PoissonDistribution(
      AttributesPoissonDistribution parameter, RandomGenerator randomGenerator) throws Exception {
  ...
  protected void setValues(AttributesPoissonDistribution parameter, RandomGenerator randomGenerator)
      throws Exception {
    distribution =
        new ExponentialDistribution(randomGenerator, 1 / parameter.getNumberPedsPerSecond());
