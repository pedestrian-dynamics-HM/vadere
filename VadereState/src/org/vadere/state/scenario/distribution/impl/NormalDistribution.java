...
public class NormalDistribution extends VDistribution<AttributesNormalDistribution> {
  ...
  private TruncatedNormalDistribution
      distribution; // we should't really go back in time -> cut the dist at 0
  ...
  protected void setValues(AttributesNormalDistribution parameter, RandomGenerator randomGenerator)
    ...
    distribution =
        new TruncatedNormalDistribution(
            randomGenerator, parameter.getMean(), parameter.getSd(), 0, Double.MAX_VALUE, 1000);
  }
