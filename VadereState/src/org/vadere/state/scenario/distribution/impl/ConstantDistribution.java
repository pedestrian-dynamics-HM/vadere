...
public class ConstantDistribution extends VDistribution<AttributesConstantDistribution> {
  ...
  @Override
  protected void setValues(AttributesConstantDistribution parameter, RandomGenerator unused)
      throws Exception {
    this.attributes = parameter;
  }

  public ConstantDistribution(AttributesConstantDistribution parameter, RandomGenerator unused)
      throws Exception {
