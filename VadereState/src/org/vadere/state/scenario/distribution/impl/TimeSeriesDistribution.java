...
public class TimeSeriesDistribution extends VDistribution<AttributesTimeSeriesDistribution> {
  ...
  @Override
  protected void setValues(AttributesTimeSeriesDistribution parameter, RandomGenerator unused2)
      throws Exception {
  ...
  private static double addNewDistribution(
      ArrayList<Integer> spawnsPerInterval,
      double intervalLength,
      ObjectMapper mapper,
      ArrayList<Double> switchpoints,
      List<AttributesDistribution> distributions,
      double currentTime,
      int i) {
    AttributesDistribution dist;

    currentTime =
        addSwitchpointIfNotLastInterval(
            spawnsPerInterval, intervalLength, switchpoints, currentTime, i);
  ...
  private static AttributesSingleSpawnDistribution initAsSingleEventDistribution(
      ArrayList<Integer> spawnsPerInterval, double intervalLength, double currentTime, int i) {
  ...
  private static AttributesConstantDistribution initAsConstantDistribution(
      double intervalLength, int spawns) {
  ...
  private static double addSwitchpointIfNotLastInterval(
      ArrayList<Integer> spawnsPerIntveral,
      double intervalLength,
      ArrayList<Double> switchpoints,
      double currentTime,
      int i) {
