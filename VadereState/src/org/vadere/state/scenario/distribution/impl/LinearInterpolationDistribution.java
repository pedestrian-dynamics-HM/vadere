...
/** @author Aleksandar Ivanov(ivanov0@hm.edu), Lukas Gradl (lgradl@hm.edu), Daniel Lehmberg */
@RegisterDistribution(
  name = "linearInterpolation",
  parameter = AttributesLinearInterpolationDistribution.class
)
public class LinearInterpolationDistribution
    extends VDistribution<AttributesLinearInterpolationDistribution> {

  public LinearInterpolationDistribution(
      AttributesLinearInterpolationDistribution parameter, RandomGenerator randomGenerator)
      throws Exception {
