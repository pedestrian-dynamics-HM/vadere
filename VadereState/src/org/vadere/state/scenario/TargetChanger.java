...
/**
 * An area with an arbitrary shape that changes the target of an agent. Either to another static
 * target or to another agent.
 */
public class TargetChanger extends ScenarioElement<AttributesTargetChanger>
    implements Comparable<TargetChanger> {

  // Member Variables
  private final Map<Integer, Double> enteringTimes;
  /**
   * Collection of listeners - unordered because it's order is not predictable (at least not for
   * clients).
   */
