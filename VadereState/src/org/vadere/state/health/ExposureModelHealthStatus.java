...
/**
 * ExposureModelHealthStatus is the abstract base class for all types of exposure a <code>Pedestrian
 * </code> can adopt.
 *
 * <p>It describes the degree to which a <code>Pedestrian</code> is exposed to infectious pathogens,
 * or in a more abstract sense, to other (infectious) agents. The degree of exposure is defined by
 * the underlying <code>AbstractExposureModel</code>.
 */
public abstract class ExposureModelHealthStatus {
  ...
  public boolean equals(Object obj) {
    ...
    return infectious == other.infectious
        && Double.compare(other.degreeOfExposure, degreeOfExposure) == 0;
  }
