...
/**
 * This annotation interface defines the OutputFileFactory. The main logic of the factory resides in
 * the OutputFileBaseFactory (util-Module). The generated java source file only provides the tedious
 * getter and Map creations. Also the mapping between OutputFile and DataKey type is created.
 */
