...
/**
 * This annotation interface define a new ModelHelper class. This class is not a Factory but the
 * generation of the source file is similar enough to use it.
 */
...
public @interface ModelClass {
  /**
   * @return Used to mark MainModels. All other models/subModels do not have to explicitly state
   *     this.
   */
