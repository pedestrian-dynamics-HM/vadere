...
/**
 * This annotation interface defines the DataProcessorFactory. The main logic of the factory resides
 * in the ProcessorBaseFactory (util-Module). The generated java source file only provides the
 * tedious getter and Map creations.
 */
