...
public class ComparablePoint extends VPoint implements Comparable<ComparablePoint> {
  ...
  /**
   * Checks whether the given point is greater than the current point with respect to:
   *
   * <ol>
   *   <li>x-coordinate and then to the
   *   <li>y-coordinate
   * </ol>
   *
  ...
  public boolean equals(Object obj) {
    ...
    if (this.compareTo(objP) == 0) return true;
    return false;
  };
}
