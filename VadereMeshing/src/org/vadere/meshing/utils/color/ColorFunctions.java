...
/**
 * Provides color values for mesh drawings depending on some functions. default implementations for
 * faceDrawColor (boarder lines) and faceFillColor (filling) are present.
 *
...
public class ColorFunctions<
  ...
  /**
   * Computes the triangle quality of this face / triangle.
   *
   * <p>Assumption: The face is a valid triangle.
   *
  ...
  public static <P extends IPoint, CE, CF, V extends IVertex, E extends IHalfEdge, F extends IFace>
      double faceToQuality(final IMesh<V, E, F> mesh, final F face) {
   ...
   */
  public static <P extends IPoint, CE, CF, V extends IVertex, E extends IHalfEdge, F extends IFace>
      Color qualityToGrayScale(final IMesh<V, E, F> mesh, final F face) {
   ...
   */
  public void setFaceFillColorFunc(
      @NotNull final BiFunction<IMesh<V, E, F>, F, Color> faceFillColorFunc) {
   ...
   */
  public void setFaceDrawColorFunc(
      @NotNull final BiFunction<IMesh<V, E, F>, F, Color> faceDrawColorFunc) {
