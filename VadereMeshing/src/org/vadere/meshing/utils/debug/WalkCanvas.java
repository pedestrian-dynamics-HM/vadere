...
public class WalkCanvas<
  ...
  /**
   * Color each visited face to show the walk and Create a straight line between start q and target
   * p
   *
   ...
   */
  public WalkCanvas(
      IMesh<V, E, F> mesh, VPoint q, VPoint p, F startFace, E startEdge, List<F> visitedFaces) {
    super(mesh);
  ...
  public static <P extends IPoint, CE, CF, V extends IVertex, E extends IHalfEdge, F extends IFace>
      WalkCanvas<P, CE, CF, V, E, F> getDefault(
          IMesh<V, E, F> mesh, VPoint p, VPoint q, F startFace, E startEdge, List<F> visitedFaces) {
  ...
  /**
   * This is called from the Constructor. Defines what should be drawn on the canvas. Note this is
   * additional to primitives defined by parent classes.
   */
