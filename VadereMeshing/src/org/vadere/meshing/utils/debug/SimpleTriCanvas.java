...
public class SimpleTriCanvas<
  ...
  private SimpleTriCanvas(
      final IMesh<V, E, F> mesh, double width, double height, VRectangle bound) {
  ...
  public static <P extends IPoint, CE, CF, V extends IVertex, E extends IHalfEdge, F extends IFace>
      SimpleTriCanvas<P, CE, CF, V, E, F> simpleCanvas(
          final IMesh<V, E, F> mesh, VRectangle bound) {
