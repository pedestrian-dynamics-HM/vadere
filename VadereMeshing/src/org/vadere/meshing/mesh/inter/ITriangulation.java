...
public interface ITriangulation<V extends IVertex, E extends IHalfEdge, F extends IFace> {
  ...
  /**
   * Returns a {@link Stream} of {@link VTriangle} which represent the triangles of this
   * triangulation.
   *
  ...
  /**
   * Returns a {@link Stream} of {@link Triple} of {@link IPoint} which represent the triangles of
   * this triangulation.
   *
