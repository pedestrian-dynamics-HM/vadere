...
public interface ITriEventListener<V extends IVertex, E extends IHalfEdge, F extends IFace> {
  ...
  /**
   * This method is triggered after a triangle is split into 3 new faces by inserting a point into
   * the triangle.
   *
  ...
  /**
   * This method is triggered after an half-edge is split. Note that if the half-edge is not at the
   * boundary, one split of an edge will result in two splits of an half-edge. The original face
   * might be reused for one of the new faces f1 or f2.
   *
