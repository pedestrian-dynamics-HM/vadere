...
public class PMeshPanel extends MeshPanel<PVertex, PHalfEdge, PFace> {
  ...
  public PMeshPanel(
      @NotNull MeshRenderer<PVertex, PHalfEdge, PFace> meshRenderer, double width, double height) {
    super(meshRenderer, width, height);
  }

  public PMeshPanel(
      @NotNull final IMesh<PVertex, PHalfEdge, PFace> mesh, double width, double height) {
  ...
  public PMeshPanel(
    ...
    super(
        mesh, f -> false, width, height, faceColorFunction, edgeColorFunction, vertexColorFunction);
  }
