 ...
 *     <p>This iterator iterates over all half-edges which end point is equal to a specific vertex.
 * @param <V> the type of the vertices
 * @param <E> the type of the half-edges
 * @param <F> the type of the faces
 */
public class EdgeOfVertexIterator<V extends IVertex, E extends IHalfEdge, F extends IFace>
