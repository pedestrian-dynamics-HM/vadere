 ...
 */
public class FaceIterator<V extends IVertex, E extends IHalfEdge, F extends IFace>
  ...
  public F next() {
    ...
    for (E he : mesh.getEdgeIt(nextFace)) {
      ...
      if (mesh.isBoundary(twinFace)
          || mesh.isDestroyed(twinFace)
          || !facePredicate.test(twinFace)) {
