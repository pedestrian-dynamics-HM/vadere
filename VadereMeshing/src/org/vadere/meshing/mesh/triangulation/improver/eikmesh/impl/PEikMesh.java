...
public class PEikMesh extends GenEikMesh<PVertex, PHalfEdge, PFace> {
  ...
  public PEikMesh(
    ...
    super(distanceFunc, edgeLengthFunc, initialEdgeLen, bound, () -> new PMesh());
  }

  public PEikMesh(
      @NotNull IDistanceFunction distanceFunc, double initialEdgeLen, @NotNull VRectangle bound) {

    super(distanceFunc, e -> 1.0, initialEdgeLen, bound, () -> new PMesh());
  }

  public PEikMesh(double initialEdgeLen, @NotNull VRectangle bound) {
