...
public class AEikMesh extends GenEikMesh<AVertex, AHalfEdge, AFace> {
	...
	public AEikMesh(
		...
		super(distanceFunc, edgeLengthFunc, initialEdgeLen, bound, obstacleShapes, AMeshWithDataStorage::constructEmpty);
	}
	...
	public AEikMesh(
			...
			double initialEdgeLen,
			@NotNull VRectangle bound) {
		super(distanceFunc, edgeLengthFunc, initialEdgeLen, bound, AMeshWithDataStorage::constructEmpty);
	}
	...
	public AEikMesh(
			...
			double initialEdgeLen,
			@NotNull VRectangle bound) {
		super(distanceFunc, e -> 1.0, initialEdgeLen, bound, AMeshWithDataStorage::constructEmpty);
	}
}