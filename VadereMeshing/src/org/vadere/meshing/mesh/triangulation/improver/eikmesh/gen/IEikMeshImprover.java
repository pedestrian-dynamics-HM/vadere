...
public interface IEikMeshImprover<V extends IVertex, E extends IHalfEdge, F extends IFace>
    extends IMeshImprover<V, E, F>, ITriangulator<V, E, F> {
  ...
  /**
   * Removes / merges {@link F} faces which are directly neighbouring the border and are of low
   * quality.
   *
   * @throws IllegalMeshException if two holes or the border and a hole collide, i.e. there are no
   *     more faces between them and therefore the mesh becomes illegal
  ...
  /**
   * Removes / merges {@link F} faces which are directly neighbouring the border or a hole and are
   * of low quality.
   *
   * @throws IllegalMeshException if two holes or the border and a hole collide, i.e. there are no
   *     more faces between them and therefore the mesh becomes illegal
