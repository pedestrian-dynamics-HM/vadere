...
/**
 * A triangulator i.e. a triangle generator creates a triangulation using a certain strategy. The
 * strategy determines which point will be inserted at which time and at which position. The
 * algorithm which inserts the point is part of the {@link ITriangulator}
 *
...
public interface ITriangulator<V extends IVertex, E extends IHalfEdge, F extends IFace> {
   ...
   * Returns the generated triangulation.
   *
   * @param finalize if true finalizes the triangulation i.e. removes all virtual vertices and
