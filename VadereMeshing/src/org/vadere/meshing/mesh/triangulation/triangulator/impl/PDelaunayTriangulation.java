...
public class PDelaunayTriangulation<P extends IPoint, CE, CF> extends GenDelaunayTriangulator<P, CE, CF, PVertex<P, CE, CF>, PHalfEdge<P, CE, CF>, PFace<P, CE, CF>> {

	public PDelaunayTriangulation(
