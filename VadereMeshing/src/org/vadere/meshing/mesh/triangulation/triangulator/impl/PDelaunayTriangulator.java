...
public class PDelaunayTriangulator extends GenDelaunayTriangulator<PVertex, PHalfEdge, PFace> {
  ...
  public PDelaunayTriangulator(
      @NotNull final PMesh mesh, @NotNull final Collection<? extends IPoint> pointSet) {
    super(mesh, pointSet);
  }

  public PDelaunayTriangulator(@NotNull final Collection<? extends IPoint> pointSet) {
