 ...
 */
public class GenRandomPointsSetTriangulator<V extends IVertex, E extends IHalfEdge, F extends IFace>
   ...
   * @param distFunc a distance function which has to be positive at positions where no point should
   *     be inserted and negative elsewhere.
   * @param random a pseudo random number generator
   */
  public GenRandomPointsSetTriangulator(
