...
/**
 * A default triangulator: This triangulator takes a set of points P and constructs the
 ...
 */
public class GenPointSetTriangulator<V extends IVertex, E extends IHalfEdge, F extends IFace>
   ...
   */
  public GenPointSetTriangulator(
      final Collection<IPoint> points, final IIncrementalTriangulation<V, E, F> triangulation) {
