...
/**
 * Computes insertion points based on a Frontal-Delaunay strategy, that is the point lies on the
 * Voronoi segment of the corresponding Voronoi-diagram.
 *
 * @param <V> the type of the vertices
 * @param <E> the type of the half-edges
 * @param <F> the type of the faces
 */
public class VoronoiSegPlacement<V extends IVertex, E extends IHalfEdge, F extends IFace>
