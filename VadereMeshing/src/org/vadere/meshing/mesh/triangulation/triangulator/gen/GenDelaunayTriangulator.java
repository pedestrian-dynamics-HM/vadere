...
public class GenDelaunayTriangulator<V extends IVertex, E extends IHalfEdge, F extends IFace>
  ...
  public GenDelaunayTriangulator(
  ...
  public GenDelaunayTriangulator(
      @NotNull final IMesh<V, E, F> mesh, @NotNull final Collection<? extends IPoint> pointSet) {
    this.pointSet = pointSet;
    this.triangulation =
        new IncrementalTriangulation<>(
            mesh, GeometryUtils.boundRelative(pointSet), halfEdge -> true);
    this.generated = false;
  }
