...
public class MeshPanel<V extends IVertex, E extends IHalfEdge, F extends IFace> extends JPanel {
  ...
  public static Function defaultFaceColors =
      f -> new Color(0.8584083044982699f, 0.9134486735870818f, 0.9645674740484429f);
   ...
   */
  public MeshPanel(
      @NotNull final MeshRenderer<V, E, F> meshRenderer, final double width, final double height) {
  ...
  public MeshPanel(
    ...
    this.meshRenderer =
        new MeshRenderer<>(mesh, alertPred, colorFunction, edgeColorFunction, vertexColorFuntion);
    this.height = height;
    this.width = width;
  }
   ...
   * @param height height of the canvas
   */
  public MeshPanel(@NotNull final IMesh<V, E, F> mesh, final double width, final double height) {
