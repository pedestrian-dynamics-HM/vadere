...
public class AFace implements IFace, Cloneable {
  ...
  /**
   * If true the face is destroyed which means it can be removed from the array-based mesh data
   * structure.
   */
  ...
  /**
   * Destroys the face. After this call the face can be removed from the array based mesh data
   * structure.
   */
  void destroy() {
    setEdge(-1);
  ...
  /**
   * Sets the array-index of this face. Note that this method should only be called by the garbage
   * collector in {@link AMesh} which adjust indices to remove destroyed base elements.
   *
  ...
  /**
   * Returns true if this face is destroyed and can be removed from the mesh data structure, false
   * otherwise.
   *
  ...
  /**
   * Sets this face to be a border face or a non-border face with respect to the parameter border.
   *
