...
public class AHalfEdge implements IHalfEdge, Cloneable {
  ...
  /**
   * Indicates that the half-edge is destroyed and can be removed from the array-based data
   * structure.
   */
  ...
  /**
   * Sets the array-index of this half-edge. Note that this method should only be called by the
   * garbage collector in {@link AMesh} which adjust indices to remove destroyed base elements.
   *
