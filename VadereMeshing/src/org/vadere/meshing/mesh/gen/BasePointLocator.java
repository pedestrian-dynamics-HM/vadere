 ...
 *     <p>The {@link BasePointLocator} only uses the mesh itself and does not use any additional
 *     data structure to find the face for a given point. It runs a march starting from some
 *     arbitrary face of the mesh and end up at the face that contains the point, if there is one.
 *     In worst case this is not faster than checking each face of the mesh but it is more clever
 *     and faste in most cases.
 * @param <V> the type of the vertices
 * @param <E> the type of the half-edges
 * @param <F> the type of the faces
 */
public class BasePointLocator<V extends IVertex, E extends IHalfEdge, F extends IFace>
