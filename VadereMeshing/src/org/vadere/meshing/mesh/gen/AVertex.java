 ...
 *
 * <p>An array-based implementation of {@link IVertex}.
 *
...
public class AVertex implements IVertex, Cloneable {
  ...
  /**
   * The array-index of the down vertex. This is only required by if one uses the {@link
   * DelaunayHierarchy} as the point location algorithm of the mesh / the triangulation.
   */
  private int down;
  ...
  /**
   * Sets the array-index of this vertex. Note that this method should only be called by the garbage
