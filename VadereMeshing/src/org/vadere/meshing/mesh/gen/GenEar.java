...
public class GenEar<V extends IVertex, E extends IHalfEdge, F extends IFace>
    implements Comparable<GenEar<V, E, F>> {
  ...
  public static class EarNodeComparator<V extends IVertex, E extends IHalfEdge, F extends IFace>
      implements Comparator<Node<GenEar<V, E, F>>> {

    @Override
    public int compare(
        @NotNull final Node<GenEar<V, E, F>> o1, @NotNull final Node<GenEar<V, E, F>> o2) {
