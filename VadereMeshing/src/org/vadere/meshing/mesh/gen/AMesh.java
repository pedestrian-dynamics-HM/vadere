...
public class AMesh implements IMesh<AVertex, AHalfEdge, AFace>, Cloneable {
  private static final Logger log = Logger.getLogger(AMesh.class);
  ...
  public <CV> Optional<CV> getData(
      @NotNull final AVertex vertex, @NotNull final String name, @NotNull Class<CV> clazz) {
  ...
  public <CV> void setData(
      @NotNull final AVertex vertex, @NotNull final String name, @Nullable final CV data) {
    if (!verticesData.containsKey(name)) {
  ...
  public <CE> Optional<CE> getData(
      @NotNull final AHalfEdge edge, @NotNull final String name, @NotNull Class<CE> clazz) {
  ...
  public <CE> void setData(
      @NotNull final AHalfEdge edge, @NotNull final String name, @Nullable final CE data) {
    if (!halfEdgesData.containsKey(name)) {
  ...
  public <CF> Optional<CF> getData(
      @NotNull final AFace face, @NotNull final String name, @NotNull Class<CF> clazz) {
  ...
  public <CF> void setData(
      @NotNull final AFace face, @NotNull final String name, @Nullable final CF data) {
    if (!facesData.containsKey(name)) {
  ...
  public void setDoubleData(
      @NotNull final AFace face, @NotNull final String name, final double data) {
    if (!facesDoubleData.containsKey(name)) {
  ...
  @Override
  public void setDoubleData(
      @NotNull final AVertex vertex, @NotNull final String name, final double data) {
    if (!verticesDoubleData.containsKey(name)) {
  ...
  @Override
  public void setDoubleData(
      @NotNull final AVertex vertex, @NotNull final int index, final double data) {
    if (verticesIndexedDoubleData.size() <= index) {
  ...
  private <CE> AObjectArrayList<CE> getObjectArrayEdge(
      @NotNull final String name, @NotNull final Class<CE> clazz) {
    if (!halfEdgesData.containsKey(name)) {
      AObjectArrayList<CE> dataArray = new AObjectArrayList<>();
      fill(dataArray, edges.size());
      halfEdgesData.put(name, dataArray);
  ...
  private <CE> AObjectArrayList<CE> getObjectArrayVertex(
      @NotNull final String name, @NotNull final Class<CE> clazz) {
    if (!verticesData.containsKey(name)) {
      AObjectArrayList<CE> dataArray = new AObjectArrayList<>();
      fill(dataArray, vertices.size());
  ...
  @Override
  public void setDoubleData(
      @NotNull final AHalfEdge edge, @NotNull final String name, final double data) {
  ...
  public void setBooleanData(
      @NotNull final AFace face, @NotNull final String name, final boolean data) {
    if (!facesBooleanData.containsKey(name)) {
      BooleanArrayList dataArray = new BooleanArrayList(faces.size());
      dataArray.size(faces.size());
      facesBooleanData.put(name, dataArray);
  ...
  @Override
  public void setBooleanData(
      @NotNull final AVertex vertex, @NotNull final String name, final boolean data) {
    if (!verticesBooleanData.containsKey(name)) {
      BooleanArrayList dataArray = new BooleanArrayList(vertices.size());
      dataArray.size(vertices.size());
      verticesBooleanData.put(name, dataArray);
  ...
  @Override
  public void setBooleanData(
      @NotNull final AHalfEdge edge, @NotNull final String name, final boolean data) {
    if (!halfEdgesBooleanData.containsKey(name)) {
      BooleanArrayList dataArray = new BooleanArrayList(edges.size());
      dataArray.size(edges.size());
      halfEdgesBooleanData.put(name, dataArray);
  ...
  public void setEdge(@NotNull AVertex vertex, @NotNull AHalfEdge edge) {
    ...
    if (edge.getEnd() != vertex.getId()) {
      throw new IllegalArgumentException(
          "end of the edge is not equals to the vertex:" + vertex.getId() + " != " + edge.getEnd());
    }
  ...
  public IIncrementalTriangulation<AVertex, AHalfEdge, AFace> toTriangulation(
      final @NotNull IPointLocator.Type type) {
  ...
  public void setPositions(final List<IPoint> positions) {
    ...
    if (positions.size() != numberOfVertices) {
      throw new IllegalArgumentException(
          "not equally many positions than vertices: "
              + positions.size()
              + " != "
              + numberOfVertices);
    }
  ...
  /**
   * Rearranges all indices of faces, vertices and halfEdges of the mesh according to the {@link
   * Iterable} faceOrder. All indices start at 0 and will be incremented one by one. For example,
   * the vertices of the first face of faceOrder will receive id 0,1 and 2.
   *
   * <p>Note: that every mapping id to vertex or id to halfEdge or id to face has to be recomputed!
   *
   * <p>Assumption: faceOrder contains all faces of this mesh.
   *
   * <p>Invariant: the geometry i.e. the connectivity and the vertex positions will not change.
   *
  ...
  @Override
  public <CV> IVertexContainerObject<AVertex, AHalfEdge, AFace, CV> getObjectVertexContainer(
  ...
  @Override
  public <CV> IEdgeContainerObject<AVertex, AHalfEdge, AFace, CV> getObjectEdgeContainer(
      @NotNull final String name, final Class<CV> clazz) {
  ...
  @Override
  public IEdgeContainerBoolean<AVertex, AHalfEdge, AFace> getBooleanEdgeContainer(
  ...
  @Override
  public IEdgeContainerDouble<AVertex, AHalfEdge, AFace> getDoubleEdgeContainer(
      @NotNull final String name) {
  ...
  @Override
  public IVertexContainerDouble<AVertex, AHalfEdge, AFace> getDoubleVertexContainer(
      @NotNull final String name) {
  ...
  @Override
  public IVertexContainerBoolean<AVertex, AHalfEdge, AFace> getBooleanVertexContainer(
      @NotNull String name) {
  ...
  private void copyFace(
      @NotNull final AFace face,
      @NotNull int[] vertexMap,
      @NotNull int[] edgeMap,
      @NotNull int[] faceMap,
      @NotNull final AMesh cMesh) {
    // merge some of them?
    int nullIdentifier = -2;
   ...
   *
   * <p>Note: that any mapping id to vertex or id to halfEdge or id to face has to be recomputed!
   */
  private void spatialSort() {
    ...
    SpaceFillingCurve spaceFillingCurve =
        new SpaceFillingCurve(new VRectangle(minX, minY, maxX - minX, maxY - minY));

    // TODO: implement faster sorting using radix sort see:
  ...
  public void garbageCollection() {
    ...
    assert (getNumberOfVertices() == vertices.size())
        && (getNumberOfEdges() == edges.size())
        && (getNumberOfFaces() == faces.size() - holes.size());
  }
