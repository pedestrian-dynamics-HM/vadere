...
public class FixPointGenerator<P extends IPoint> {
  ...
  public Collection<P> generate(
      final VShape shape,
      final Function<IPoint, Double> segmentLenFunc,
    ...
    while (!path.isDone()) {
      ...
      SplitLineIterator<P> iterator =
          new SplitLineIterator<>(
              new VLine(coordinates[0], coordinates[1], tempCoords[0], tempCoords[1]),
              segmentLenFunc,
              pointConstructor);
