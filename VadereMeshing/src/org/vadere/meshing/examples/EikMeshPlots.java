...
/**
 * Script to construct Tikz-Plots for different edge length functions and geometries which are used
 * for the manuel and the documentation.
 */
public class EikMeshPlots {
  ...
  public static void randomDelaunay() throws IOException, InterruptedException {
    ...
    dt.generate();
    // write(toTexDocument(TexGraphGenerator.toTikz(dt.getMesh(), f -> lightBlue, 1.0f)),
    ...
    // write(toTexDocument(TexGraphGenerator.toTikz(meshImprover.getMesh(), f -> lightBlue, 1.0f)),
    // "eikmesh_random_after");
  }
  ...
  public static void kaiserslautern() throws IOException, InterruptedException {
    ...
    write(
        toTexDocument(TexGraphGenerator.toTikz(meshImprover.getMesh(), f -> lightBlue, 1.0f)),
        "eikmesh_kaiserslautern_" + Double.toString(h0).replace('.', '_'));
  ...
  public static void roomLFS() throws IOException, InterruptedException {
    ...
    EdgeLengthFunctionApprox edgeLengthFunctionApprox =
        new EdgeLengthFunctionApprox(pslg, p -> 2.0);
  ...
  public static void cornerLFS() throws IOException, InterruptedException {
    ...
    PSLG pslg = PSLGGenerator.toPSLG(inputStream);
    EdgeLengthFunctionApprox edgeLengthFunctionApprox =
        new EdgeLengthFunctionApprox(pslg, p -> 1.0);
    edgeLengthFunctionApprox.printPython();
  ...
  public static void eikMeshA(double h0) throws IOException, InterruptedException {
    ...
    meshImprover.generate();
    write(
        toTexDocument(TexGraphGenerator.toTikz(meshImprover.getMesh(), f -> lightBlue, 10.0f)),
        "eikmesh_a_" + Double.toString(h0).replace('.', '_'));
  ...
  public static void distanceFuncCombination(double h0) throws IOException {
    ...
    write(
        toTexDocument(TexGraphGenerator.toTikz(meshImprover.getMesh(), f -> lightBlue, 10.0f)),
        "eikmesh_d_combined_" + Double.toString(h0).replace('.', '_'));
  ...
  public static void discSubtractRect(double h0) throws IOException {
    ...
    write(
        toTexDocument(TexGraphGenerator.toTikz(meshImprover.getMesh(), f -> lightBlue, 10.0f)),
        "eikmesh_disc_rect_non_uniform_" + Double.toString(h0).replace('.', '_'));
  ...
  public static void discSubtractRect2(double h0) throws IOException {
    ...
    write(
        toTexDocument(TexGraphGenerator.toTikz(meshImprover.getMesh(), f -> lightBlue, 10.0f)),
        "eikmesh_disc_rect_sub_non_uniform_" + Double.toString(h0).replace('.', '_'));
  ...
  public static void uniformRing(double h0) throws InterruptedException, IOException {
    ...
    write(
        toTexDocument(TexGraphGenerator.toTikz(meshImprover.getMesh(), f -> lightBlue, 10.0f)),
        "eikmesh_ring_uniform_" + Double.toString(h0).replace('.', '_'));
  ...
  public static void discXAdaptive(final double h0) throws IOException {
    ...
    PEikMesh meshImprover = new PEikMesh(ringDistance, edgeLengthFunction, h0, bound);
    ...
    write(
        toTexDocument(TexGraphGenerator.toTikz(meshImprover.getMesh(), f -> lightBlue, 10.0f)),
        "eikmesh_disc_xadaptive_" + Double.toString(h0).replace('.', '_'));
  ...
  public static void ruppertsAndEikMeshKaiserslautern() throws IOException {
    ...
    var ruppert = new PRuppertsTriangulator(pslg, p -> 0.01, 0.0);
