...
public class TestTriangulationOperations {
  ...
  public void testCollapse() {
    ...
    PVertex vertex =
        mesh.streamVertices().filter(v -> mesh.toPoint(v).equals(collapsePoint)).findAny().get();
    ...
    assertTrue(
        mesh.streamEdges(mesh.getBorder()).allMatch(e -> mesh.getFace(e).equals(mesh.getBorder())));
    ...
    assertTrue(
        mesh.streamVertices()
            .allMatch(
                v -> mesh.getFace(v).equals(mesh.getBorder()) || mesh.getFace(v).equals(face)));
