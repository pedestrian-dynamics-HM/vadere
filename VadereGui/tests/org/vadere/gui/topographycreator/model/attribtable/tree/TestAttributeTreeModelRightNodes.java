...
/**
 * these tests check if AttributeTree.parseClassTree(..) creates the right nodes types for the given
 * tested class types
 */
  ...
  public void testClassWithRegisteredAttribute() {
    ...
    Assert.assertTrue(
        tree.getChildren()
            ...
            .getSecond()
            .getClass()
            .isAssignableFrom(FieldNode.class));
  }
  ...
  public void testClassWithListType() {
    ...
    Assert.assertTrue(
        tree.getChildren()
            ...
            .getSecond()
            .getClass()
            .isAssignableFrom(ArrayNode.class));
  }
  ...
  public void testClassWithAbstractType() {
    ...
    Assert.assertTrue(
        tree.getChildren()
            ...
            .getSecond()
            .getClass()
            .isAssignableFrom(AbstrNode.class));
  }
