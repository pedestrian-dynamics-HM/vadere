...
public class ActionRandomPedestrianDialog {
  ...
  private void createGuiElements() {
    ...
    groupMembershipRatioField =
        new JTextField(String.format(Locale.US, "%.1f", groupMembershipRatio), 15);
  ...
  private void createTargetRadioButtons() {
    ...
    rbTargetEmpty =
        new JRadioButton(
            Messages.getString("TopographyCreator.PlaceRandomPedestrians.targetEmptyOption.label"),
            true);
    rbTargetRandom =
        new JRadioButton(
            Messages.getString("TopographyCreator.PlaceRandomPedestrians.targetRandomOption.label"),
            false);
    rbTargetUseList =
        new JRadioButton(
            Messages.getString("TopographyCreator.PlaceRandomPedestrians.targetListOption.label"),
            false);
    ...
    rbTargetUseList.addItemListener(
        new ItemListener() {
          @Override
  ...
  private void placeGuiElements() {
    ...
    panelWindow.add(
        new JLabel("Set Number of Pedestrians"), c(GridBagConstraints.HORIZONTAL, col0, row));
    panelWindow.add(numberOfPedsField, c(GridBagConstraints.HORIZONTAL, col1, row++));

    panelWindow.add(
        new JLabel("In Boundary Rectangle"), c(GridBagConstraints.HORIZONTAL, col0, row));
    ...
    panelWindow.add(
        new JLabel("Set Random Seed (-1 for random)"), c(GridBagConstraints.HORIZONTAL, col0, row));
    panelWindow.add(seedField, c(GridBagConstraints.HORIZONTAL, col1, row++));

    panelWindow.add(
        new JLabel("Ingroup Membership Ratio"), c(GridBagConstraints.HORIZONTAL, col0, row));
    panelWindow.add(groupMembershipRatioField, c(GridBagConstraints.HORIZONTAL, col1, row++));

    panelWindow.add(
        new JLabel("May take a while because intelligent distance function not available yet..."),
