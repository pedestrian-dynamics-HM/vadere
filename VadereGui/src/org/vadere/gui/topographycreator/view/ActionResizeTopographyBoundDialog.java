...
public class ActionResizeTopographyBoundDialog {
  ...
  public ActionResizeTopographyBoundDialog(final Rectangle2D.Double topographyBound) {
    ...
    textField.setText(
        String.format(
            Locale.US, "%.3f x %.3f", topographyBound.getWidth(), topographyBound.getHeight()));
    textField
        .getDocument()
        .addDocumentListener(
                ...
                try {
                  ...
                  ActionResizeTopographyBoundDialog.this.bound =
                      new Rectangle2D.Double(
                          ActionResizeTopographyBoundDialog.this.boundOld.getMinX(),
                          ActionResizeTopographyBoundDialog.this.boundOld.getMinY(),
                          width,
                          height);
