...
/**
 * Dialog which collects the ids of selected obstacles. The collected list will be combined into a
 * single obstacle based on the convex hull.
 *
...
public class ActionCombineDialog extends JDialog implements ISelectScenarioElementListener {
  ...
  public ActionCombineDialog(
      ActionSimplifyObstacles action, ActionListener okBtn, IDrawPanelModel<?> panelModel) {
