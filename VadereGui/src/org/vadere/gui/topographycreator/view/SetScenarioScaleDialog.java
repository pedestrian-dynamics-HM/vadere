...
public class SetScenarioScaleDialog extends JDialog {
  ...
  public SetScenarioScaleDialog(
      final IDrawPanelModel model, final UndoableEditSupport undoSupport) {
    getContentPane()
        .setLayout(
            new FormLayout(
                new ColumnSpec[] {
          ...
          public void actionPerformed(ActionEvent event) {
            ...
            try {
              ...
              JOptionPane.showMessageDialog(
                  SetScenarioScaleDialog.this,
                  "Pleaese enter a floating number bigger than zero.",
                  "Error",
