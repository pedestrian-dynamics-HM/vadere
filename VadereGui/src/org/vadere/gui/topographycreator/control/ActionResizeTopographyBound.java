...
public class ActionResizeTopographyBound extends TopographyAction {
  ...
  public ActionResizeTopographyBound(
      String name,
      String iconPath,
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    ActionResizeTopographyBoundDialog dialog =
        new ActionResizeTopographyBoundDialog(model.getTopographyBound());
    ...
    if (dialog.getValue()) {
      ...
      undoableEditSupport.postEdit(
          new EditResizeTopographyBound(getScenarioPanelModel(), oldBound, newBound));
    }
