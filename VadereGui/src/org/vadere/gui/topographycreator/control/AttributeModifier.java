...
/**
 * Setter implementation to modify shape of Attributes. Do not use this class outside of the
 * topographycreator package, or even not outside this control-package!
 */
public class AttributeModifier {
  /**
   * Sets the shape to the attributes of an topography element. Use this method only in the control!
   *
