...
public class ActionQuickSaveTopography extends TopographyAction {
  ...
  public ActionQuickSaveTopography(
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (lastSavePoint == null) {
      ...
      if (returnVal == JFileChooser.APPROVE_OPTION) {
        File file =
            fc.getSelectedFile().toString().endsWith(".json")
                ? fc.getSelectedFile()
      ...
      TopographyJsonWriter.writeTopography(
          getScenarioPanelModel().build(), new File(lastSavePoint));
    }
  }
}
