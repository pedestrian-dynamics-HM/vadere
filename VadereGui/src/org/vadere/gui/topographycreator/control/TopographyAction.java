 ...
 * panelModel. Actions are part of the controller of the mvc-pattern.
 */
public abstract class TopographyAction extends AbstractAction {
  ...
  public TopographyAction(
      final String name, final String iconPath, final IDrawPanelModel<?> panelModel) {
