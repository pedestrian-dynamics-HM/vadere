...
/**
 * JCollapsablePanel implements a panel with a header which hides its content when the header is
 * clicked upon.
 */
public class JCollapsablePanel extends JPanel implements Observer {
  ...
  /**
   * This method is used for adding components directly with the wanted layout contraints
   *
  ...
  /**
   * SectionHeaderMouseInputAdapter is used as a listener for mouse input to hande the state
   * switching of the contents visibility if the panel is section panel
   */
  ...
  /**
   * GroupHeaderMouseInputAdapter is used as a listener for mouse input to hande the state switching
   * of the contents visibility if the panel is group panel
   */
