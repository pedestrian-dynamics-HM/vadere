...
public class VPointCellEditor extends AttributeEditor {
  ...
  private void resizeEditor(
      JPanel xContentPanel, JPanel yContentPanel, JLabel xLable, JLabel yLabel) {
