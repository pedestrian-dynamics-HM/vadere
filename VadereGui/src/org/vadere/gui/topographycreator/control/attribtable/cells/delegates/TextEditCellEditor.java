...
/**
 * @author Ludwig Jaeck This class is a table delegate for editing string fields. To figure out if
 *     the UI model changed a DocumentFilter is used.
 */
public class TextEditCellEditor extends AttributeEditor {
  ...
  protected void initialize(Object initialValue) {
    ...
    if (initialValue != null) this.textField.setText((String) initialValue);
