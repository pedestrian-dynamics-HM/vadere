...
/** @author Ludwig Jaeck This class is a table delegate for editing Double fields. */
public class DoubleSpinnerCellEditor extends AttributeEditor {
  private JSpinner spinner;

  @Override
  public java.util.List<Component> getInputComponent() {
    return Collections.singletonList(((JSpinner.NumberEditor) spinner.getEditor()).getTextField());
  }
  ...
  protected void initialize(Object initialValue) {
    ...
    if (initialValue != null) this.spinner.setValue(initialValue);
  ...
  private void initializeSpinnerValue() {
    ...
    if (value != null) this.spinner.setValue(((FieldNode) model).getValueNode().getValue());
  }
