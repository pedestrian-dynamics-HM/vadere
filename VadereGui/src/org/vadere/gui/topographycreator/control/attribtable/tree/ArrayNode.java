...
public class ArrayNode extends AttributeTreeModel.TreeNode {
  ...
  public ArrayNode(AttributeTreeModel.TreeNode parent, Field field) {
    ...
    try {
      ...
      throw new RuntimeException(
          "Could not find a default constructor for class "
              + genericType
              + "when creating ArrayNode");
    }
  ...
  public void updateValues(Object obj) throws IllegalAccessException {
    if (obj != null) {
      if (obj.equals(getReference())) return;
      setReference(obj);
      ...
      for (int i = 0; i < array.size(); i++) {
        ...
        if (Modifier.isAbstract(genericType.getModifiers())) {
          ...
          newNode =
              new FieldNode(this, key, genericType, new ValueNode(this, key, genericType, value));
        }

        children.put(
            key, new Pair(null, newNode)); // new ValueNode(this, key, value.getClass(), value)
      }
    }
    notifyStructureListeners();
    notifyValueListeners();
  ...
  public void updateParentsFieldValue(String fieldName, Object object)
    ...
    SwingUtilities.invokeLater(
        () -> {
          ...
          (super.getChildren().get(fieldName).getSecond())
              .setValueNode(new ValueNode(this, fieldName, genericType, object));
  ...
  public void addElement()
    ...
    if (Modifier.isAbstract(genericType.getModifiers())) {
      ...
      newNode =
          new FieldNode(this, key, genericType, new ValueNode(this, key, genericType, newInstance));
    }
