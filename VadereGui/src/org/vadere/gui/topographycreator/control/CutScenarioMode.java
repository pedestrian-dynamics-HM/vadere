...
public class CutScenarioMode extends RectangleSelectionMode {
  ...
  public void mouseReleased(MouseEvent event) {
    ...
    UndoableEdit edit =
        new EditCutScenario(panelModel, new VRectangle(panelModel.getTopographyBound()));
    ...
    panelModel.setTopographyBound(
        new VRectangle(
            x,
            y,
            bound.getWidth() + 2 * panelModel.getBoundingBoxWidth(),
