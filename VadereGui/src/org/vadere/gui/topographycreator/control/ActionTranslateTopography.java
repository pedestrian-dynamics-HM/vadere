...
public class ActionTranslateTopography extends TopographyAction {
  ...
  public ActionTranslateTopography(
      String name,
      String iconPath,
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    ActionTranslateTopographyDialog dialog =
        new ActionTranslateTopographyDialog(topographyBound.getMinX(), topographyBound.getMinY());
    ...
    if (dialog.getValue()) {
      ...
      TopographyCreatorModel topographyCreatorModel =
          (TopographyCreatorModel) getScenarioPanelModel();
      topographyCreatorModel.translateTopography(x, y);

      VRectangle viewportBound =
          new VRectangle(model.getViewportBound()).translate(new VPoint(x - xOld, y - yOld));
      topographyCreatorModel.setViewportBound(viewportBound);
      undoableEditSupport.postEdit(
          new EditTranslateTopography(topographyCreatorModel, xOld, yOld, x, y));
    }
