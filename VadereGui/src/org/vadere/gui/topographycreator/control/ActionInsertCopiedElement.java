...
public class ActionInsertCopiedElement extends TopographyAction {
  ...
  public ActionInsertCopiedElement(
      final String name, final IDrawPanelModel<?> model, final UndoableEditSupport undoSupport) {
    super(name, model);
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (elementToCopy instanceof AgentWrapper) {
      VPoint position =
          new VPoint(newShape.getBounds2D().getCenterX(), newShape.getBounds2D().getCenterY());
