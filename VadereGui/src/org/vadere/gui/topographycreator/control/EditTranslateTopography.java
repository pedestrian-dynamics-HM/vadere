...
public class EditTranslateTopography extends AbstractUndoableEdit {
  ...
  public EditTranslateTopography(
      @NotNull final TopographyCreatorModel panelModel,
      final double xOld,
      final double yOld,
      final double xNew,
      final double yNew) {
  ...
  public void undo() throws CannotUndoException {
    ...
    VRectangle viewportBound =
        new VRectangle(panelModel.getViewportBound())
            .translate(new VPoint(xOld - xNew, yOld - yNew));
  ...
  public void redo() throws CannotRedoException {
    ...
    VRectangle viewportBound =
        new VRectangle(panelModel.getViewportBound())
            .translate(new VPoint(xNew - xOld, yNew - yOld));
    panelModel.setViewportBound(viewportBound);
  }
