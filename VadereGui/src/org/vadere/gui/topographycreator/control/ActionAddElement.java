...
/**
 * Adds a new ScenarioElment to the Model and set the json content of the panelModel. This is a
 * helper class to avoid duplicated code in the DrawXXXMode-Classes!
 */
class ActionAddElement extends TopographyAction {
  ...
  ActionAddElement(
      final String name, IDrawPanelModel panelModel, final UndoableEditSupport undoSupport) {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    ScenarioElement element =
        TopographyElementFactory.getInstance()
            .createScenarioShape(model.getCurrentType(), model.getSelectionShape());
