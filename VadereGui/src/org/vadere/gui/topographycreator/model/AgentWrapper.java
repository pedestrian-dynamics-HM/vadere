...
/**
 * The AgentWrapper wraps an AgentInitialStore to a ScenarioElement, so the TopographyCreator can
 * treat every Element the same way. In the Creator every Element can be drawn to the screen so
 * every Element contains an VShape especially the PedestrianInitialStore.
 */
