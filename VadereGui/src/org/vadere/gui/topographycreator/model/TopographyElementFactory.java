...
public class TopographyElementFactory {
  ...
  public ScenarioElement createScenarioShape(final ScenarioElementType type, final VShape shape) {
    switch (type) {
      ...
      case STAIRS:
        return new org.vadere.state.scenario.Stairs(
            new AttributesStairs(-1, shape, 1, new Vector2D(1.0, 0.0)));
      case SOURCE:
      ...
      case MEASUREMENT_AREA:
        return new org.vadere.state.scenario.MeasurementArea(
            new AttributesMeasurementArea(-1, shape));
      default:
