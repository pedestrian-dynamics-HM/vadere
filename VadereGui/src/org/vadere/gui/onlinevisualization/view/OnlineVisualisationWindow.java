...
public class OnlineVisualisationWindow extends JPanel implements Observer {
  ...
  public OnlineVisualisationWindow(
      final MainPanel mainPanel, final OnlineVisualizationModel model) {
    ...
    scenarioScrollPane
        .getViewport()
        .addChangeListener(
            new JViewportChangeListener(model, scenarioScrollPane.getVerticalScrollBar()));
    model.addScrollPane(scenarioScrollPane);

    IViewportChangeListener viewportChangeListener =
        new ViewportChangeListener(model, scenarioScrollPane);
    ...
    AbstractAction openSettingsDialog =
    ...
    AbstractAction paintArrowAction =
        new AbstractAction(
            "paintArrowAction", resources.getIcon("walking_direction.png", iconWidth, iconHeight)) {
    ...
    AbstractAction paintPedestriansAction =
        new AbstractAction(
            "paintPedestrianAction", resources.getIcon("pedestrian.png", iconWidth, iconHeight)) {
    ...
    AbstractAction showGroupInformationAction =
        new AbstractAction(
            "showGroupInformationAction", resources.getIcon("group.png", iconWidth, iconHeight)) {
          @Override
          public void actionPerformed(ActionEvent e) {
    ...
    AbstractAction drawVoronoiDiagram =
        new ActionSwapSelectionMode(
            "draw_voronoi_diagram", resources.getIcon("voronoi.png", iconWidth, iconHeight), model);

    AbstractAction drawMesh =
        new ActionShowMesh(
            "draw_mesh", resources.getIcon("triangulation.png", iconWidth, iconHeight), model);

    AbstractAction paintGridAction =
        new AbstractAction(
            "paintGridAction", resources.getIcon("grid.png", iconWidth, iconHeight)) {
    ...
    AbstractAction paintTrajectories =
        new AbstractAction(
            "paintTrajectoriesAction",
    ...
    AbstractAction paintDensity =
        new AbstractAction(
            "paintDensityAction", resources.getIcon("density.png", iconWidth, iconHeight)) {
    ...
    ActionGenerateTikz generateTikz =
    ...
    ActionGenerateINETenv generateINETenv =
    ...
    ActionGeneratePoly generatePoly =
    ...
    ActionShowPotentialField showPotentialField =
    ...
    ActionRecording recording =
        new ActionRecording(
            "showPotentialField", resources.getIcon("record.png", iconWidth, iconHeight), renderer);
    ...
    SwingUtils.addActionToToolbar(
        toolbar,
        paintPedestriansAction,
        Messages.getString("ProjectView.btnShowPedestrian.tooltip"));
    SwingUtils.addActionToToolbar(
        toolbar, paintTrajectories, Messages.getString("ProjectView.btnShowTrajectories.tooltip"));
    SwingUtils.addActionToToolbar(
        toolbar,
        paintArrowAction,
    ...
    SwingUtils.addActionToToolbar(
        toolbar, drawMesh, Messages.getString("ProjectView.btnDrawMesh.tooltip"));
    SwingUtils.addActionToToolbar(
        toolbar, paintGridAction, Messages.getString("ProjectView.btnShowGrid.tooltip"));
    SwingUtils.addActionToToolbar(
        toolbar, paintDensity, Messages.getString("ProjectView.btnShowDensity.tooltip"));
    toolbar.addSeparator();
    ...
    ActionOnlineVisMenu imgDialog =
        new ActionOnlineVisMenu(
            "camera_menu", resources.getIcon("camera.png", iconWidth, iconHeight), imgOptions);
    JButton imgMenuBtn =
        SwingUtils.addActionToToolbar(
    ...
    SwingUtils.addActionToToolbar(
        toolbar, showPotentialField, Messages.getString("OnlineVis.btnShowPotentialfield.tooltip"));
    JButton recordButton =
        SwingUtils.addActionToToolbar(
            toolbar, recording, Messages.getString("OnlineVis.btnRecord.tooltip"));
    recording.setButton(recordButton);

    toolbar.add(Box.createHorizontalGlue());

    SwingUtils.addActionToToolbar(
        toolbar, openSettingsDialog, Messages.getString("ProjectView.btnSettings.tooltip"));
