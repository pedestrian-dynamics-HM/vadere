...
/**
 * Quick implementation of a console. This is necessary as there may be no console when application
 * won't be started within Eclipse for example. Calls to System.out or System.err are redirected to
 * the consoles internal text buffer.
 */
public class Console {
  ...
  /**
   * Creates a new console window. System.out and System.err are redirected to the internal text
   * buffer.
   */
  public Console() {
  ...
  /** Should be called at end of simulation only, as displaying the window slows down simulation. */
