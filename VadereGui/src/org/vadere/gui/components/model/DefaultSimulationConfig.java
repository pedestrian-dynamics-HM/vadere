...
public class DefaultSimulationConfig extends DefaultConfig {
  ...
  public DefaultSimulationConfig(final DefaultSimulationConfig config) {
    ...
    for (Map.Entry<Integer, Color> entry : config.pedestrianColors.entrySet()) {
      this.pedestrianColors.put(
          new Integer(entry.getKey()),
          new Color(
              entry.getValue().getRed(), entry.getValue().getGreen(), entry.getValue().getBlue()));
    }
  ...
  public boolean isShowTargetChangers() {
    return showTargetChangers;
  }
  ...
  public void addPedestrianColors(
      final Map<Integer, Color> pedestrianColors, final boolean override) {
    if (override) {
  ...
  public boolean isShowPedestrianInOutGroup() {
    return showPedestrianInOutGroup;
  }
