...
public interface IDefaultModel<T extends DefaultConfig> extends Iterable<ScenarioElement> {
  ...
  /**
   * Set the window position where the selection starts. This helps to calculate the selected area
  ...
  /**
   * Set a shape that framed the selected area. A renderer can draw this in a special way so that
  ...
  /**
   * Returns the selection shape. A renderer can draw this in a special way so that the user knows
   * what is selected.
   *
  ...
  /**
   * Return the scale factor. A large scale factor results in displaying only a small part of the
   * topography.
   *
  ...
  /**
   * Return the grid resolution. The grid resolution is responsible for the refinement of the
   * displayed grid. If the scale factor is large, the grid resolution shall be small.
   *
  ...
  /**
   * Set the selection element. The element will be the element that contains the world position. If
   * at the position is no element, the selection element will be null.
   *
  ...
  /**
   * Add a SelectScenarioElementListener to the model. All listeners will be notified if the
   * selection of an element change.
   *
  ...
  /**
   * Notify all observers of this model (not the SelectScenarioElementListener). Only the control
