...
public class InfoPanel extends JPanel implements Observer {
  ...
  public InfoPanel(final IDefaultModel defaultModel) {
    ...
    lblScenarioHashValue.addMouseListener(
        new MouseAdapter() {
          @Override
  ...
  private void setToolTips() {
    String unitLengthText =
        String.format(
            "%s: [%s]", Messages.getString("Units.title"), Messages.getString("Units.length"));
    ...
    String unitDimensionlessText =
        String.format(
            "%s: [%s]",
            Messages.getString("Units.title"), Messages.getString("Units.dimensionless"));
  ...
  public void update(Observable o, Object arg) {
    if (defaultModel.getTopography() != null) {
      ...
      lblGridResolutionValue.setText(
          String.format("%3.2f [m] | ", defaultModel.getGridResolution()));
      lblScenarioSizeValue.setText(
          String.format(
              "(%3.2f x %3.2f) [m] | ",
              (float) topographyBound.getWidth(), (float) topographyBound.getHeight()));
      lblCursorPositionValue.setText(
          String.format(
              "%3.2f %3.2f | ",
              (float) defaultModel.getMousePosition().getX(),
