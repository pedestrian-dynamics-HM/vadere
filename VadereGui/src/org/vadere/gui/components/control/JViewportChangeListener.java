...
public class JViewportChangeListener implements ChangeListener {
  ...
  public JViewportChangeListener(
      final IDefaultModel defaultModel, final JScrollBar verticalScrollbar) {
  ...
  public void stateChanged(final ChangeEvent e) {
    ...
    if (topographyBound != null) {
      ...
      double x =
          Math.max(
              topographyBound.getMinX(),
              topographyBound.getMinX() + rect.getX() / defaultModel.getScaleFactor());
      ...
      double y =
          Math.max(
              topographyBound.getMinY(),
              topographyBound.getMinY()
                  + topographyBound.getHeight()
