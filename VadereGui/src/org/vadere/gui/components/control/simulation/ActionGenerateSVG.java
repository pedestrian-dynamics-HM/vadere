...
public class ActionGenerateSVG extends AbstractAction implements IRendererChangeListener {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    SimpleDateFormat formatter =
        new SimpleDateFormat(VadereConfig.getConfig().getString("SettingsDialog.dataFormat"));
    ...
    File outputFile =
        new File(Messages.getString("FileDialog.filenamePrefix") + formattedDate + ".svg");
    ...
    if (returnVal == JFileChooser.APPROVE_OPTION) {
      ...
      outputFile =
          fileChooser.getSelectedFile().toString().endsWith(".svg")
