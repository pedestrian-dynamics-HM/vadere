...
public class DefaultModeAdapter implements IMode {
   ...
   *
   * <ul>
   *   <li>Ctrl + Mouse Wheel Scroll: Zoom in/out.
   *   <li>Mouse Wheel Scroll: Scroll vertically.
   *   <li>Shift + Mouse Wheel Scroll: Scroll horizontally.
   *   <li>Use Alt key to decrease the step size while scrolling.
   * </ul>
   *
   * @param e
   */
  ...
  public void mouseWheelMoved(MouseWheelEvent e) {
    if (e.isControlDown()) {
      ...
      MouseWheelEvent scrollEvent =
          (e.isAltDown()) ? getSmallStepScrollEvent(e) : getBigStepScrollEvent(e);
  ...
  private MouseWheelEvent getSmallStepScrollEvent(MouseWheelEvent baseEvent) {
    MouseWheelEvent smallScrollEvent =
        new MouseWheelEvent(
