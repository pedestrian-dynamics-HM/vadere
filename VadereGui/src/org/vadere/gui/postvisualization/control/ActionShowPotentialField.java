...
public class ActionShowPotentialField extends ActionVisualization {
  ...
  public ActionShowPotentialField(
      final String name, final Icon icon, final PostvisualizationModel model) {
        ...
        Runnable runnable =
            () -> {
              ...
              try {
                ...
                PotentialFieldContainer container =
                    new PotentialFieldContainer(
                        file,
                        topography.getBounds().getWidth(),
                        topography.getBounds().getHeight(),
                        false);
