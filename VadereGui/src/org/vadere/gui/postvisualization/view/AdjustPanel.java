...
public class AdjustPanel extends JPanel implements Observer {
  ...
  public AdjustPanel(final PostvisualizationModel model) {
    ...
    sModelTimeResolution =
        new SpinnerNumberModel(model.config.getTimeResolution(), 0.01, Double.MAX_VALUE, 0.01);
    ...
    lblVelocity =
        new JLabel(
            String.format(
                labelTemplate, Messages.getString("AdjustPanel.lblVelocity.text"), "fps"));
    lblTime =
        new JLabel(String.format(labelTemplate, Messages.getString("AdjustPanel.lblTime"), "s"));
    lblStep =
        new JLabel(
            String.format(labelTemplate, Messages.getString("AdjustPanel.lblStep.text"), "-"));
    lblTimeResolution =
        new JLabel(
            String.format(
                labelTemplate, Messages.getString("AdjustPanel.lblTimeResolution.text"), "s"));
    ...
    sTimeResolution.addChangeListener(
        e -> {
  ...
  private void setToolTips() {
    String unitFramesText =
        String.format(
            "%s: [%s]", Messages.getString("Units.title"), Messages.getString("Units.fps"));
    ...
    String unitTimeText =
        String.format(
            "%s: [%s]", Messages.getString("Units.title"), Messages.getString("Units.time"));
    ...
    String unitSimStepText =
        String.format(
            "%s: [%s]", Messages.getString("Units.title"), Messages.getString("Units.simStep"));
