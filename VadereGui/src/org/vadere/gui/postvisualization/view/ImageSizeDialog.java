  ...
  public ImageSizeDialog(final SimulationModel<? extends DefaultSimulationConfig> model) {
    ...
    this.imageSize =
        new Rectangle2D.Double(
            0,
            0,
            ImageGenerator.calculateOptimalWidth(model),
    ...
    FormLayout mainLayout =
        new FormLayout(
            "5dlu, pref, 2dlu, pref, 2dlu, pref, 5dlu", // 2 col
    ...
    sModelImageWidth =
        new SpinnerNumberModel(ImageGenerator.calculateOptimalWidth(model), 1, 5000, 1);
    ...
    sModelImageHeight =
        new SpinnerNumberModel(ImageGenerator.calculateOptimalHeight(model), 1, 5000, 1);
