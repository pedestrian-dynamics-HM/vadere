...
public class InetEnvironmentGenerator {
  ...
  private static final Logger logger = Logger.getLogger(InetEnvironmentGenerator.class);
  private final SimulationRenderer renderer;
  private final SimulationModel<? extends DefaultSimulationConfig> model;

  public InetEnvironmentGenerator(
  ...
  private void createObjectsWithShape(AffineTransform affTransformation, StringBuilder sb) {
    ...
    for (Obstacle o : obstacles) {
      ...
      EnvObject envObject =
          EnvObject.createPrism(o.getId(), transformedShape, 5.0, new Color(200, 0, 0));
  ...
  private static class EnvObject {
    ...
    private void buildPrismShape(VShape transformedShape, double height) {
      ...
      VPoint base =
          new VPoint(
              transformedShape.getBounds2D().getMinX(), transformedShape.getBounds2D().getMinY());
