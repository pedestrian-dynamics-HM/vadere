...
public class ActionRunOutput extends AbstractAction {
  ...
  public void actionPerformed(ActionEvent e) {
    try {
      ...
      try {
        Scenario vadere = IOOutput.readScenarioRunManager(outputBundle.getProject(), directoryName);
        OfflineSimulation offlineSimulation =
            new OfflineSimulation(
        ...
        logger.error(
            "Could not run offline simulation (simulate output):" + e1.getLocalizedMessage());
        e1.printStackTrace();
      }
