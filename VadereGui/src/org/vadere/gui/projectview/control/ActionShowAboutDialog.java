...
public class ActionShowAboutDialog extends AbstractAction {
  ...
  public void actionPerformed(final ActionEvent event) {
    String releaseVersion =
        String.format(
            "%s: %s", Messages.getString("ProjectView.version.release"), Version.releaseNumber());
    String versionControlInfo =
        String.format(
            "%s: %s",
            Messages.getString("ProjectView.version.commit"),
            Version.getVersionControlCommitHash());
    String license =
        String.format(
            "%s: %s",
            Messages.getString("ProjectView.license.text"),
    ...
    JOptionPane.showMessageDialog(
        null,
        text,
        Messages.getString("ProjectView.aboutDialog.label"),
        JOptionPane.INFORMATION_MESSAGE,
        new ImageIcon(resources.getImage("vadere_small.png")));
  }
}
