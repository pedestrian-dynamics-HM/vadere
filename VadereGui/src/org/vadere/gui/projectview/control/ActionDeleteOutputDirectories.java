...
public class ActionDeleteOutputDirectories extends AbstractAction {
  ...
  public ActionDeleteOutputDirectories(
      final String name, final ProjectViewModel model, VTable outputTable) {
    super(name);
    this.model = model;
  ...
  public void actionPerformed(ActionEvent event) {
    ...
    if (selectedCount > 0
        && IOUtils.chooseYesNoCancel(questionText, Messages.getString("DeleteOutputQuestion.title"))
